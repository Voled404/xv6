...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
      ...
      12:	48 c7 c6 96 46 00 00 	mov    $0x4696,%rsi
      19:	89 c7                	mov    %eax,%edi
      1b:	b8 00 00 00 00       	mov    $0x0,%eax
      20:	e8 45 40 00 00       	call   406a <printf>
  fd = open("echo", 0);
      25:	be 00 00 00 00       	mov    $0x0,%esi
      2a:	48 c7 c7 80 46 00 00 	mov    $0x4680,%rdi
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      ...
      45:	48 c7 c6 a1 46 00 00 	mov    $0x46a1,%rsi
      4c:	89 c7                	mov    %eax,%edi
      4e:	b8 00 00 00 00       	mov    $0x0,%eax
      53:	e8 12 40 00 00       	call   406a <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
      ...
      6c:	48 c7 c7 b4 46 00 00 	mov    $0x46b4,%rdi
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      ...
      cd:	48 c7 c6 ed 46 00 00 	mov    $0x46ed,%rsi
      d4:	89 c7                	mov    %eax,%edi
      d6:	b8 00 00 00 00       	mov    $0x0,%eax
      db:	e8 8a 3f 00 00       	call   406a <printf>
  fd = open("small", O_CREATE|O_RDWR);
      e0:	be 02 02 00 00       	mov    $0x202,%esi
      e5:	48 c7 c7 fe 46 00 00 	mov    $0x46fe,%rdi
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     100:	48 c7 c6 04 47 00 00 	mov    $0x4704,%rsi
     107:	89 c7                	mov    %eax,%edi
     109:	b8 00 00 00 00       	mov    $0x0,%eax
     10e:	e8 57 3f 00 00       	call   406a <printf>
  } else {
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     161:	48 c7 c6 48 47 00 00 	mov    $0x4748,%rsi
     168:	89 c7                	mov    %eax,%edi
     16a:	b8 00 00 00 00       	mov    $0x0,%eax
     16f:	e8 f6 3e 00 00       	call   406a <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     181:	48 c7 c6 6c 47 00 00 	mov    $0x476c,%rsi
     ...
     19d:	48 c7 c6 78 47 00 00 	mov    $0x4778,%rsi
     1a4:	89 c7                	mov    %eax,%edi
     1a6:	b8 00 00 00 00       	mov    $0x0,%eax
     1ab:	e8 ba 3e 00 00       	call   406a <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     1c9:	48 c7 c6 9c 47 00 00 	mov    $0x479c,%rsi
     1d0:	89 c7                	mov    %eax,%edi
     1d2:	b8 00 00 00 00       	mov    $0x0,%eax
     1d7:	e8 8e 3e 00 00       	call   406a <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     1eb:	48 c7 c7 fe 46 00 00 	mov    $0x46fe,%rdi
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     206:	48 c7 c6 a7 47 00 00 	mov    $0x47a7,%rsi
     20d:	89 c7                	mov    %eax,%edi
     20f:	b8 00 00 00 00       	mov    $0x0,%eax
     214:	e8 51 3e 00 00       	call   406a <printf>
  } else {
  ...
  if(unlink("small") < 0){
     27e:	48 c7 c7 fe 46 00 00 	mov    $0x46fe,%rdi
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     2fa:	48 c7 c6 24 48 00 00 	mov    $0x4824,%rsi
     301:	89 c7                	mov    %eax,%edi
     303:	b8 00 00 00 00       	mov    $0x0,%eax
     308:	e8 5d 3d 00 00       	call   406a <printf>

  fd = open("big", O_CREATE|O_RDWR);
     30d:	be 02 02 00 00       	mov    $0x202,%esi
     312:	48 c7 c7 34 48 00 00 	mov    $0x4834,%rdi
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     32d:	48 c7 c6 38 48 00 00 	mov    $0x4838,%rsi
     334:	89 c7                	mov    %eax,%edi
     336:	b8 00 00 00 00       	mov    $0x0,%eax
     33b:	e8 2a 3d 00 00       	call   406a <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     380:	48 c7 c6 52 48 00 00 	mov    $0x4852,%rsi
     387:	89 c7                	mov    %eax,%edi
     389:	b8 00 00 00 00       	mov    $0x0,%eax
     38e:	e8 d7 3c 00 00       	call   406a <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     3b5:	48 c7 c7 34 48 00 00 	mov    $0x4834,%rdi
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     3d0:	48 c7 c6 70 48 00 00 	mov    $0x4870,%rsi
     3d7:	89 c7                	mov    %eax,%edi
     3d9:	b8 00 00 00 00       	mov    $0x0,%eax
     3de:	e8 87 3c 00 00       	call   406a <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     424:	48 c7 c6 89 48 00 00 	mov    $0x4889,%rsi
     42b:	89 c7                	mov    %eax,%edi
     42d:	b8 00 00 00 00       	mov    $0x0,%eax
     432:	e8 33 3c 00 00       	call   406a <printf>
        exit();
     ...
     44e:	48 c7 c6 a6 48 00 00 	mov    $0x48a6,%rsi
     455:	89 c7                	mov    %eax,%edi
     457:	b8 00 00 00 00       	mov    $0x0,%eax
     45c:	e8 09 3c 00 00       	call   406a <printf>
      exit();
    ...
    if(((int*)buf)[0] != n){
     ...
     486:	48 c7 c6 b8 48 00 00 	mov    $0x48b8,%rsi
     48d:	89 c7                	mov    %eax,%edi
     48f:	b8 00 00 00 00       	mov    $0x0,%eax
     494:	e8 d1 3b 00 00       	call   406a <printf>
      exit();
  ...
  if(unlink("big") < 0){
     4b2:	48 c7 c7 34 48 00 00 	mov    $0x4834,%rdi
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     50e:	48 c7 c6 00 49 00 00 	mov    $0x4900,%rsi
     515:	89 c7                	mov    %eax,%edi
     517:	b8 00 00 00 00       	mov    $0x0,%eax
     51c:	e8 49 3b 00 00       	call   406a <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     5ab:	48 c7 c6 28 49 00 00 	mov    $0x4928,%rsi
     5b2:	89 c7                	mov    %eax,%edi
     5b4:	b8 00 00 00 00       	mov    $0x0,%eax
     5b9:	e8 ac 3a 00 00       	call   406a <printf>
}
     5be:	90                   	nop
     5bf:	c9                   	leave
     5c0:	c3                   	ret
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     5cf:	48 c7 c6 4e 49 00 00 	mov    $0x494e,%rsi
     5d6:	89 c7                	mov    %eax,%edi
     5d8:	b8 00 00 00 00       	mov    $0x0,%eax
     5dd:	e8 88 3a 00 00       	call   406a <printf>

  if(mkdir("dir0") < 0){
     5e2:	48 c7 c7 5a 49 00 00 	mov    $0x495a,%rdi
    ...
    printf(stdout, "mkdir failed\n");
     ...
     5f8:	48 c7 c6 5f 49 00 00 	mov    $0x495f,%rsi
     5ff:	89 c7                	mov    %eax,%edi
     601:	b8 00 00 00 00       	mov    $0x0,%eax
     606:	e8 5f 3a 00 00       	call   406a <printf>
    exit();
     60b:	e8 a0 38 00 00       	call   3eb0 <exit>
  }

  if(chdir("dir0") < 0){
     610:	48 c7 c7 5a 49 00 00 	mov    $0x495a,%rdi
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     626:	48 c7 c6 6d 49 00 00 	mov    $0x496d,%rsi
     62d:	89 c7                	mov    %eax,%edi
     62f:	b8 00 00 00 00       	mov    $0x0,%eax
     634:	e8 31 3a 00 00       	call   406a <printf>
    exit();
     639:	e8 72 38 00 00       	call   3eb0 <exit>
  }

  if(chdir("..") < 0){
     63e:	48 c7 c7 80 49 00 00 	mov    $0x4980,%rdi
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     654:	48 c7 c6 83 49 00 00 	mov    $0x4983,%rsi
     65b:	89 c7                	mov    %eax,%edi
     65d:	b8 00 00 00 00       	mov    $0x0,%eax
     662:	e8 03 3a 00 00       	call   406a <printf>
    exit();
     667:	e8 44 38 00 00       	call   3eb0 <exit>
  }

  if(unlink("dir0") < 0){
     66c:	48 c7 c7 5a 49 00 00 	mov    $0x495a,%rdi
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     ...
     6c4:	48 c7 c6 a8 49 00 00 	mov    $0x49a8,%rsi
     6cb:	89 c7                	mov    %eax,%edi
     6cd:	b8 00 00 00 00       	mov    $0x0,%eax
     6d2:	e8 93 39 00 00       	call   406a <printf>
  if(exec("echo", echoargv) < 0){
     6d7:	48 c7 c6 e0 63 00 00 	mov    $0x63e0,%rsi
     6de:	48 c7 c7 80 46 00 00 	mov    $0x4680,%rdi
    ...
    printf(stdout, "exec echo failed\n");
     ...
     6f4:	48 c7 c6 b3 49 00 00 	mov    $0x49b3,%rsi
     6fb:	89 c7                	mov    %eax,%edi
     6fd:	b8 00 00 00 00       	mov    $0x0,%eax
     702:	e8 63 39 00 00       	call   406a <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     72b:	48 c7 c6 c5 49 00 00 	mov    $0x49c5,%rsi
     732:	bf 01 00 00 00       	mov    $0x1,%edi
     737:	b8 00 00 00 00       	mov    $0x0,%eax
     73c:	e8 29 39 00 00       	call   406a <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     7bb:	48 c7 c6 d4 49 00 00 	mov    $0x49d4,%rsi
     7c2:	bf 01 00 00 00       	mov    $0x1,%edi
     7c7:	b8 00 00 00 00       	mov    $0x0,%eax
     7cc:	e8 99 38 00 00       	call   406a <printf>
        exit();
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     833:	48 c7 c6 e2 49 00 00 	mov    $0x49e2,%rsi
     83a:	bf 01 00 00 00       	mov    $0x1,%edi
     83f:	b8 00 00 00 00       	mov    $0x0,%eax
     844:	e8 21 38 00 00       	call   406a <printf>
    ...
    if(total != 5 * 1033){
     ...
     8a3:	48 c7 c6 f0 49 00 00 	mov    $0x49f0,%rsi
     8aa:	bf 01 00 00 00       	mov    $0x1,%edi
     8af:	b8 00 00 00 00       	mov    $0x0,%eax
     8b4:	e8 b1 37 00 00       	call   406a <printf>
      exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     90e:	48 c7 c6 20 4a 00 00 	mov    $0x4a20,%rsi
     915:	bf 01 00 00 00       	mov    $0x1,%edi
     91a:	b8 00 00 00 00       	mov    $0x0,%eax
     91f:	e8 46 37 00 00       	call   406a <printf>
  pid1 = fork();
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     9cd:	48 c7 c6 40 4a 00 00 	mov    $0x4a40,%rsi
     9d4:	bf 01 00 00 00       	mov    $0x1,%edi
     9d9:	b8 00 00 00 00       	mov    $0x0,%eax
     9de:	e8 87 36 00 00       	call   406a <printf>
  ...
  printf(1, "kill... ");
     9ef:	48 c7 c6 53 4a 00 00 	mov    $0x4a53,%rsi
     9f6:	bf 01 00 00 00       	mov    $0x1,%edi
     9fb:	b8 00 00 00 00       	mov    $0x0,%eax
     a00:	e8 65 36 00 00       	call   406a <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     a23:	48 c7 c6 5c 4a 00 00 	mov    $0x4a5c,%rsi
     a2a:	bf 01 00 00 00       	mov    $0x1,%edi
     a2f:	b8 00 00 00 00       	mov    $0x0,%eax
     a34:	e8 31 36 00 00       	call   406a <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     a48:	48 c7 c6 65 4a 00 00 	mov    $0x4a65,%rsi
     a4f:	bf 01 00 00 00       	mov    $0x1,%edi
     a54:	b8 00 00 00 00       	mov    $0x0,%eax
     a59:	e8 0c 36 00 00       	call   406a <printf>
}
     a5e:	c9                   	leave
     a5f:	c3                   	ret
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a81:	79 18                	jns    a9b <exitwait+0x3b>
      printf(1, "fork failed\n");
     a83:	48 c7 c6 71 4a 00 00 	mov    $0x4a71,%rsi
     a8a:	bf 01 00 00 00       	mov    $0x1,%edi
     a8f:	b8 00 00 00 00       	mov    $0x0,%eax
     a94:	e8 d1 35 00 00       	call   406a <printf>
      return;
    ...
    if(pid){
     ...
     aab:	48 c7 c6 7e 4a 00 00 	mov    $0x4a7e,%rsi
     ab2:	bf 01 00 00 00       	mov    $0x1,%edi
     ab7:	b8 00 00 00 00       	mov    $0x0,%eax
     abc:	e8 a9 35 00 00       	call   406a <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ad2:	48 c7 c6 8e 4a 00 00 	mov    $0x4a8e,%rsi
     ad9:	bf 01 00 00 00       	mov    $0x1,%edi
     ade:	b8 00 00 00 00       	mov    $0x0,%eax
     ae3:	e8 82 35 00 00       	call   406a <printf>
}
     ae8:	c9                   	leave
     ae9:	c3                   	ret
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     af6:	48 c7 c6 9b 4a 00 00 	mov    $0x4a9b,%rsi
     afd:	bf 01 00 00 00       	mov    $0x1,%edi
     b02:	b8 00 00 00 00       	mov    $0x0,%eax
     b07:	e8 5e 35 00 00       	call   406a <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     b48:	e8 1c 3a 00 00       	call   4569 <malloc>
    ...
    while(m1){
     ...
     b6c:	e8 65 38 00 00       	call   43d6 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     bc1:	e8 10 38 00 00       	call   43d6 <free>
    printf(1, "mem ok\n");
     bc6:	48 c7 c6 bf 4a 00 00 	mov    $0x4abf,%rsi
     bcd:	bf 01 00 00 00       	mov    $0x1,%edi
     bd2:	b8 00 00 00 00       	mov    $0x0,%eax
     bd7:	e8 8e 34 00 00       	call   406a <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     bf5:	48 c7 c6 c7 4a 00 00 	mov    $0x4ac7,%rsi
     bfc:	bf 01 00 00 00       	mov    $0x1,%edi
     c01:	b8 00 00 00 00       	mov    $0x0,%eax
     c06:	e8 5f 34 00 00       	call   406a <printf>

  unlink("sharedfd");
     c0b:	48 c7 c7 d6 4a 00 00 	mov    $0x4ad6,%rdi
     c12:	e8 e9 32 00 00       	call   3f00 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     c17:	be 02 02 00 00       	mov    $0x202,%esi
     c1c:	48 c7 c7 d6 4a 00 00 	mov    $0x4ad6,%rdi
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     c31:	48 c7 c6 e0 4a 00 00 	mov    $0x4ae0,%rsi
     c38:	bf 01 00 00 00       	mov    $0x1,%edi
     c3d:	b8 00 00 00 00       	mov    $0x0,%eax
     c42:	e8 23 34 00 00       	call   406a <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c9d:	48 c7 c6 10 4b 00 00 	mov    $0x4b10,%rsi
     ca4:	bf 01 00 00 00       	mov    $0x1,%edi
     ca9:	b8 00 00 00 00       	mov    $0x0,%eax
     cae:	e8 b7 33 00 00       	call   406a <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     ce1:	48 c7 c7 d6 4a 00 00 	mov    $0x4ad6,%rdi
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     cf6:	48 c7 c6 30 4b 00 00 	mov    $0x4b30,%rsi
     cfd:	bf 01 00 00 00       	mov    $0x1,%edi
     d02:	b8 00 00 00 00       	mov    $0x0,%eax
     d07:	e8 5e 33 00 00       	call   406a <printf>
    return;
  ...
  unlink("sharedfd");
     d82:	48 c7 c7 d6 4a 00 00 	mov    $0x4ad6,%rdi
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     da0:	48 c7 c6 5b 4b 00 00 	mov    $0x4b5b,%rsi
     da7:	bf 01 00 00 00       	mov    $0x1,%edi
     dac:	b8 00 00 00 00       	mov    $0x0,%eax
     db1:	e8 b4 32 00 00       	call   406a <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     dc2:	48 c7 c6 68 4b 00 00 	mov    $0x4b68,%rsi
     dc9:	bf 01 00 00 00       	mov    $0x1,%edi
     dce:	b8 00 00 00 00       	mov    $0x0,%eax
     dd3:	e8 92 32 00 00       	call   406a <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     deb:	48 c7 c6 7d 4b 00 00 	mov    $0x4b7d,%rsi
     df2:	bf 01 00 00 00       	mov    $0x1,%edi
     df7:	b8 00 00 00 00       	mov    $0x0,%eax
     dfc:	e8 69 32 00 00       	call   406a <printf>

  unlink("f1");
     e01:	48 c7 c7 8c 4b 00 00 	mov    $0x4b8c,%rdi
     e08:	e8 f3 30 00 00       	call   3f00 <unlink>
  unlink("f2");
     e0d:	48 c7 c7 8f 4b 00 00 	mov    $0x4b8f,%rdi
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     e27:	48 c7 c6 71 4a 00 00 	mov    $0x4a71,%rsi
     e2e:	bf 01 00 00 00       	mov    $0x1,%edi
     e33:	b8 00 00 00 00       	mov    $0x0,%eax
     e38:	e8 2d 32 00 00       	call   406a <printf>
    exit();
  ...
  fname = pid ? "f1" : "f2";
     ...
     e48:	48 c7 c0 8c 4b 00 00 	mov    $0x4b8c,%rax
     e4f:	eb 07                	jmp    e58 <twofiles+0x79>
     e51:	48 c7 c0 8f 4b 00 00 	mov    $0x4b8f,%rax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     e76:	48 c7 c6 92 4b 00 00 	mov    $0x4b92,%rsi
     e7d:	bf 01 00 00 00       	mov    $0x1,%edi
     e82:	b8 00 00 00 00       	mov    $0x0,%eax
     e87:	e8 de 31 00 00       	call   406a <printf>
    exit();
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     ee6:	48 c7 c6 a1 4b 00 00 	mov    $0x4ba1,%rsi
     eed:	bf 01 00 00 00       	mov    $0x1,%edi
     ef2:	b8 00 00 00 00       	mov    $0x0,%eax
     ef7:	e8 6e 31 00 00       	call   406a <printf>
      exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    fd = open(i?"f1":"f2", 0);
     ...
     f37:	48 c7 c0 8c 4b 00 00 	mov    $0x4b8c,%rax
     f3e:	eb 07                	jmp    f47 <twofiles+0x168>
     f40:	48 c7 c0 8f 4b 00 00 	mov    $0x4b8f,%rax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f8c:	74 1b                	je     fa9 <twofiles+0x1ca>
          printf(1, "wrong char\n");
     f8e:	48 c7 c6 b2 4b 00 00 	mov    $0x4bb2,%rsi
     f95:	bf 01 00 00 00       	mov    $0x1,%edi
     f9a:	b8 00 00 00 00       	mov    $0x0,%eax
     f9f:	e8 c6 30 00 00       	call   406a <printf>
          exit();
    ...
    if(total != 12*500){
     ...
     ff2:	48 c7 c6 be 4b 00 00 	mov    $0x4bbe,%rsi
     ff9:	bf 01 00 00 00       	mov    $0x1,%edi
     ffe:	b8 00 00 00 00       	mov    $0x0,%eax
    1003:	e8 62 30 00 00       	call   406a <printf>
      exit();
  ...
  unlink("f1");
    101b:	48 c7 c7 8c 4b 00 00 	mov    $0x4b8c,%rdi
    1022:	e8 d9 2e 00 00       	call   3f00 <unlink>
  unlink("f2");
    1027:	48 c7 c7 8f 4b 00 00 	mov    $0x4b8f,%rdi
    102e:	e8 cd 2e 00 00       	call   3f00 <unlink>

  printf(1, "twofiles ok\n");
    1033:	48 c7 c6 cf 4b 00 00 	mov    $0x4bcf,%rsi
    103a:	bf 01 00 00 00       	mov    $0x1,%edi
    103f:	b8 00 00 00 00       	mov    $0x0,%eax
    1044:	e8 21 30 00 00       	call   406a <printf>
}
    1049:	90                   	nop
    104a:	c9                   	leave
    104b:	c3                   	ret
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1058:	48 c7 c6 dc 4b 00 00 	mov    $0x4bdc,%rsi
    105f:	bf 01 00 00 00       	mov    $0x1,%edi
    1064:	b8 00 00 00 00       	mov    $0x0,%eax
    1069:	e8 fc 2f 00 00       	call   406a <printf>
  pid = fork();
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    107c:	48 c7 c6 71 4a 00 00 	mov    $0x4a71,%rsi
    1083:	bf 01 00 00 00       	mov    $0x1,%edi
    1088:	b8 00 00 00 00       	mov    $0x0,%eax
    108d:	e8 d8 2f 00 00       	call   406a <printf>
    exit();
  ...
  for(i = 0; i < N; i++){
    ...
    10dd:	79 1b                	jns    10fa <createdelete+0xae>
      printf(1, "create failed\n");
    10df:	48 c7 c6 92 4b 00 00 	mov    $0x4b92,%rsi
    10e6:	bf 01 00 00 00       	mov    $0x1,%edi
    10eb:	b8 00 00 00 00       	mov    $0x0,%eax
    10f0:	e8 75 2f 00 00       	call   406a <printf>
      exit();
    ...
    1136:	48 c7 c6 ef 4b 00 00 	mov    $0x4bef,%rsi
    113d:	bf 01 00 00 00       	mov    $0x1,%edi
    1142:	b8 00 00 00 00       	mov    $0x0,%eax
    1147:	e8 1e 2f 00 00       	call   406a <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    11b5:	48 c7 c6 00 4c 00 00 	mov    $0x4c00,%rsi
    11bc:	bf 01 00 00 00       	mov    $0x1,%edi
    11c1:	b8 00 00 00 00       	mov    $0x0,%eax
    11c6:	e8 9f 2e 00 00       	call   406a <printf>
      exit();
    ...
    11e9:	48 c7 c6 28 4c 00 00 	mov    $0x4c28,%rsi
    11f0:	bf 01 00 00 00       	mov    $0x1,%edi
    11f5:	b8 00 00 00 00       	mov    $0x0,%eax
    11fa:	e8 6b 2e 00 00       	call   406a <printf>
      exit();
    ...
    124e:	48 c7 c6 00 4c 00 00 	mov    $0x4c00,%rsi
    1255:	bf 01 00 00 00       	mov    $0x1,%edi
    125a:	b8 00 00 00 00       	mov    $0x0,%eax
    125f:	e8 06 2e 00 00       	call   406a <printf>
      exit();
    ...
    1282:	48 c7 c6 28 4c 00 00 	mov    $0x4c28,%rsi
    1289:	bf 01 00 00 00       	mov    $0x1,%edi
    128e:	b8 00 00 00 00       	mov    $0x0,%eax
    1293:	e8 d2 2d 00 00       	call   406a <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
    12f7:	48 c7 c6 48 4c 00 00 	mov    $0x4c48,%rsi
    12fe:	bf 01 00 00 00       	mov    $0x1,%edi
    1303:	b8 00 00 00 00       	mov    $0x0,%eax
    1308:	e8 5d 2d 00 00       	call   406a <printf>
}
    130d:	90                   	nop
    130e:	c9                   	leave
    130f:	c3                   	ret
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    131c:	48 c7 c6 59 4c 00 00 	mov    $0x4c59,%rsi
    1323:	bf 01 00 00 00       	mov    $0x1,%edi
    1328:	b8 00 00 00 00       	mov    $0x0,%eax
    132d:	e8 38 2d 00 00       	call   406a <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1332:	be 02 02 00 00       	mov    $0x202,%esi
    1337:	48 c7 c7 6a 4c 00 00 	mov    $0x4c6a,%rdi
  ...
  if(fd < 0){
    ...
    134c:	48 c7 c6 75 4c 00 00 	mov    $0x4c75,%rsi
    1353:	bf 01 00 00 00       	mov    $0x1,%edi
    1358:	b8 00 00 00 00       	mov    $0x0,%eax
    135d:	e8 08 2d 00 00       	call   406a <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    136f:	48 c7 c6 8f 4c 00 00 	mov    $0x4c8f,%rsi
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    138c:	48 c7 c7 6a 4c 00 00 	mov    $0x4c6a,%rdi
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    13ec:	48 c7 c7 6a 4c 00 00 	mov    $0x4c6a,%rdi
  ...
  write(fd1, "yyy", 3);
    ...
    1403:	48 c7 c6 c7 4c 00 00 	mov    $0x4cc7,%rsi
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1436:	48 c7 c6 cb 4c 00 00 	mov    $0x4ccb,%rsi
    143d:	bf 01 00 00 00       	mov    $0x1,%edi
    1442:	b8 00 00 00 00       	mov    $0x0,%eax
    1447:	e8 1e 2c 00 00       	call   406a <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    145c:	48 c7 c6 e2 4c 00 00 	mov    $0x4ce2,%rsi
    1463:	bf 01 00 00 00       	mov    $0x1,%edi
    1468:	b8 00 00 00 00       	mov    $0x0,%eax
    146d:	e8 f8 2b 00 00       	call   406a <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1492:	48 c7 c6 f9 4c 00 00 	mov    $0x4cf9,%rsi
    1499:	bf 01 00 00 00       	mov    $0x1,%edi
    149e:	b8 00 00 00 00       	mov    $0x0,%eax
    14a3:	e8 c2 2b 00 00       	call   406a <printf>
    exit();
  ...
  unlink("unlinkread");
    14b7:	48 c7 c7 6a 4c 00 00 	mov    $0x4c6a,%rdi
    14be:	e8 3d 2a 00 00       	call   3f00 <unlink>
  printf(1, "unlinkread ok\n");
    14c3:	48 c7 c6 12 4d 00 00 	mov    $0x4d12,%rsi
    14ca:	bf 01 00 00 00       	mov    $0x1,%edi
    14cf:	b8 00 00 00 00       	mov    $0x0,%eax
    14d4:	e8 91 2b 00 00       	call   406a <printf>
}
    14d9:	90                   	nop
    14da:	c9                   	leave
    14db:	c3                   	ret
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    14e8:	48 c7 c6 21 4d 00 00 	mov    $0x4d21,%rsi
    14ef:	bf 01 00 00 00       	mov    $0x1,%edi
    14f4:	b8 00 00 00 00       	mov    $0x0,%eax
    14f9:	e8 6c 2b 00 00       	call   406a <printf>

  unlink("lf1");
    14fe:	48 c7 c7 2b 4d 00 00 	mov    $0x4d2b,%rdi
    1505:	e8 f6 29 00 00       	call   3f00 <unlink>
  unlink("lf2");
    150a:	48 c7 c7 2f 4d 00 00 	mov    $0x4d2f,%rdi
    1511:	e8 ea 29 00 00       	call   3f00 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1516:	be 02 02 00 00       	mov    $0x202,%esi
    151b:	48 c7 c7 2b 4d 00 00 	mov    $0x4d2b,%rdi
  ...
  if(fd < 0){
    ...
    1530:	48 c7 c6 33 4d 00 00 	mov    $0x4d33,%rsi
    1537:	bf 01 00 00 00       	mov    $0x1,%edi
    153c:	b8 00 00 00 00       	mov    $0x0,%eax
    1541:	e8 24 2b 00 00       	call   406a <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    15fe:	48 c7 c7 2f 4d 00 00 	mov    $0x4d2f,%rdi
  ...
  if(fd < 0){
    ...
    1613:	48 c7 c6 95 4d 00 00 	mov    $0x4d95,%rsi
    161a:	bf 01 00 00 00       	mov    $0x1,%edi
    161f:	b8 00 00 00 00       	mov    $0x0,%eax
    1624:	e8 41 2a 00 00       	call   406a <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1649:	48 c7 c6 a6 4d 00 00 	mov    $0x4da6,%rsi
    1650:	bf 01 00 00 00       	mov    $0x1,%edi
    1655:	b8 00 00 00 00       	mov    $0x0,%eax
    165a:	e8 0b 2a 00 00       	call   406a <printf>
    exit();
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1735:	48 c7 c6 26 4e 00 00 	mov    $0x4e26,%rsi
    173c:	bf 01 00 00 00       	mov    $0x1,%edi
    1741:	b8 00 00 00 00       	mov    $0x0,%eax
    1746:	e8 1f 29 00 00       	call   406a <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    17b3:	48 c7 c7 36 4e 00 00 	mov    $0x4e36,%rdi
    ...
    17fd:	48 c7 c7 36 4e 00 00 	mov    $0x4e36,%rdi
    ...
    182c:	48 c7 c6 39 4e 00 00 	mov    $0x4e39,%rsi
    1833:	bf 01 00 00 00       	mov    $0x1,%edi
    1838:	b8 00 00 00 00       	mov    $0x0,%eax
    183d:	e8 28 28 00 00       	call   406a <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    188a:	48 c7 c7 fb 4d 00 00 	mov    $0x4dfb,%rdi
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    18f0:	48 c7 c6 55 4e 00 00 	mov    $0x4e55,%rsi
    18f7:	bf 01 00 00 00       	mov    $0x1,%edi
    18fc:	b8 00 00 00 00       	mov    $0x0,%eax
    1901:	e8 64 27 00 00       	call   406a <printf>
        exit();
    ...
    1924:	48 c7 c6 6e 4e 00 00 	mov    $0x4e6e,%rsi
    192b:	bf 01 00 00 00       	mov    $0x1,%edi
    1930:	b8 00 00 00 00       	mov    $0x0,%eax
    1935:	e8 30 27 00 00       	call   406a <printf>
        exit();
  ...
  if(n != 40){
    ...
    197e:	48 c7 c6 90 4e 00 00 	mov    $0x4e90,%rsi
    1985:	bf 01 00 00 00       	mov    $0x1,%edi
    198a:	b8 00 00 00 00       	mov    $0x0,%eax
    198f:	e8 d6 26 00 00       	call   406a <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    19ba:	79 1b                	jns    19d7 <concreate+0x2ae>
      printf(1, "fork failed\n");
    19bc:	48 c7 c6 71 4a 00 00 	mov    $0x4a71,%rsi
    19c3:	bf 01 00 00 00       	mov    $0x1,%edi
    19c8:	b8 00 00 00 00       	mov    $0x0,%eax
    19cd:	e8 98 26 00 00       	call   406a <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1ae6:	48 c7 c6 c1 4e 00 00 	mov    $0x4ec1,%rsi
    1aed:	bf 01 00 00 00       	mov    $0x1,%edi
    1af2:	b8 00 00 00 00       	mov    $0x0,%eax
    1af7:	e8 6e 25 00 00       	call   406a <printf>
}
    1afc:	90                   	nop
    1afd:	c9                   	leave
    1afe:	c3                   	ret
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1b0b:	48 c7 c6 cf 4e 00 00 	mov    $0x4ecf,%rsi
    1b12:	bf 01 00 00 00       	mov    $0x1,%edi
    1b17:	b8 00 00 00 00       	mov    $0x0,%eax
    1b1c:	e8 49 25 00 00       	call   406a <printf>

  unlink("x");
    1b21:	48 c7 c7 2a 4a 00 00 	mov    $0x4a2a,%rdi
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1b3b:	48 c7 c6 71 4a 00 00 	mov    $0x4a71,%rsi
    1b42:	bf 01 00 00 00       	mov    $0x1,%edi
    1b47:	b8 00 00 00 00       	mov    $0x0,%eax
    1b4c:	e8 19 25 00 00       	call   406a <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1bb1:	48 c7 c7 2a 4a 00 00 	mov    $0x4a2a,%rdi
    ...
    1be9:	75 15                	jne    1c00 <linkunlink+0x101>
      link("cat", "x");
    1beb:	48 c7 c6 2a 4a 00 00 	mov    $0x4a2a,%rsi
    1bf2:	48 c7 c7 e0 4e 00 00 	mov    $0x4ee0,%rdi
    1bf9:	e8 12 23 00 00       	call   3f10 <link>
    1bfe:	eb 0c                	jmp    1c0c <linkunlink+0x10d>
    } else {
      unlink("x");
    1c00:	48 c7 c7 2a 4a 00 00 	mov    $0x4a2a,%rdi
  ...
  printf(1, "linkunlink ok\n");
    1c2c:	48 c7 c6 e4 4e 00 00 	mov    $0x4ee4,%rsi
    1c33:	bf 01 00 00 00       	mov    $0x1,%edi
    1c38:	b8 00 00 00 00       	mov    $0x0,%eax
    1c3d:	e8 28 24 00 00       	call   406a <printf>
}
    1c42:	90                   	nop
    1c43:	c9                   	leave
    1c44:	c3                   	ret
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1c51:	48 c7 c6 f3 4e 00 00 	mov    $0x4ef3,%rsi
    1c58:	bf 01 00 00 00       	mov    $0x1,%edi
    1c5d:	b8 00 00 00 00       	mov    $0x0,%eax
    1c62:	e8 03 24 00 00       	call   406a <printf>
  unlink("bd");
    1c67:	48 c7 c7 00 4f 00 00 	mov    $0x4f00,%rdi
    1c6e:	e8 8d 22 00 00       	call   3f00 <unlink>

  fd = open("bd", O_CREATE);
    1c73:	be 00 02 00 00       	mov    $0x200,%esi
    1c78:	48 c7 c7 00 4f 00 00 	mov    $0x4f00,%rdi
  ...
  if(fd < 0){
    ...
    1c8d:	48 c7 c6 03 4f 00 00 	mov    $0x4f03,%rsi
    1c94:	bf 01 00 00 00       	mov    $0x1,%edi
    1c99:	b8 00 00 00 00       	mov    $0x0,%eax
    1c9e:	e8 c7 23 00 00       	call   406a <printf>
    exit();
  ...
  unlink("bd");
    1d30:	48 c7 c7 00 4f 00 00 	mov    $0x4f00,%rdi
  ...
  for(i = 0; i < 500; i++){
    ...
    1d8b:	48 c7 c6 2d 4f 00 00 	mov    $0x4f2d,%rsi
    1d92:	bf 01 00 00 00       	mov    $0x1,%edi
    1d97:	b8 00 00 00 00       	mov    $0x0,%eax
    1d9c:	e8 c9 22 00 00       	call   406a <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1db3:	48 c7 c6 42 4f 00 00 	mov    $0x4f42,%rsi
    1dba:	bf 01 00 00 00       	mov    $0x1,%edi
    1dbf:	b8 00 00 00 00       	mov    $0x0,%eax
    1dc4:	e8 a1 22 00 00       	call   406a <printf>
}
    1dc9:	90                   	nop
    1dca:	c9                   	leave
    1dcb:	c3                   	ret
...
subdir(void)
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1e2a:	48 c7 c7 78 4f 00 00 	mov    $0x4f78,%rdi
  ...
  if(fd < 0){
    ...
    1e3f:	48 c7 c6 7e 4f 00 00 	mov    $0x4f7e,%rsi
    1e46:	bf 01 00 00 00       	mov    $0x1,%edi
    1e4b:	b8 00 00 00 00       	mov    $0x0,%eax
    1e50:	e8 15 22 00 00       	call   406a <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1e62:	48 c7 c6 5a 4f 00 00 	mov    $0x4f5a,%rsi
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ed5:	48 c7 c7 e0 4f 00 00 	mov    $0x4fe0,%rdi
  ...
  if(fd < 0){
    ...
    1eea:	48 c7 c6 e9 4f 00 00 	mov    $0x4fe9,%rsi
    1ef1:	bf 01 00 00 00       	mov    $0x1,%edi
    1ef6:	b8 00 00 00 00       	mov    $0x0,%eax
    1efb:	e8 6a 21 00 00       	call   406a <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    1f0d:	48 c7 c6 01 50 00 00 	mov    $0x5001,%rsi
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1f2a:	48 c7 c7 04 50 00 00 	mov    $0x5004,%rdi
  ...
  if(fd < 0){
    ...
    1f3f:	48 c7 c6 10 50 00 00 	mov    $0x5010,%rsi
    1f46:	bf 01 00 00 00       	mov    $0x1,%edi
    1f4b:	b8 00 00 00 00       	mov    $0x0,%eax
    1f50:	e8 15 21 00 00       	call   406a <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1f84:	48 c7 c6 29 50 00 00 	mov    $0x5029,%rsi
    1f8b:	bf 01 00 00 00       	mov    $0x1,%edi
    1f90:	b8 00 00 00 00       	mov    $0x0,%eax
    1f95:	e8 d0 20 00 00       	call   406a <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    20e7:	48 c7 c7 44 50 00 00 	mov    $0x5044,%rdi
  ...
  if(fd < 0){
    ...
    20fc:	48 c7 c6 12 51 00 00 	mov    $0x5112,%rsi
    2103:	bf 01 00 00 00       	mov    $0x1,%edi
    2108:	b8 00 00 00 00       	mov    $0x0,%eax
    210d:	e8 58 1f 00 00       	call   406a <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2132:	48 c7 c6 2a 51 00 00 	mov    $0x512a,%rsi
    2139:	bf 01 00 00 00       	mov    $0x1,%edi
    213e:	b8 00 00 00 00       	mov    $0x0,%eax
    2143:	e8 22 1f 00 00       	call   406a <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2536:	48 c7 c6 b0 53 00 00 	mov    $0x53b0,%rsi
    253d:	bf 01 00 00 00       	mov    $0x1,%edi
    2542:	b8 00 00 00 00       	mov    $0x0,%eax
    2547:	e8 1e 1b 00 00       	call   406a <printf>

  unlink("bigwrite");
    254c:	48 c7 c7 bf 53 00 00 	mov    $0x53bf,%rdi
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2569:	48 c7 c7 bf 53 00 00 	mov    $0x53bf,%rdi
    ...
    257e:	48 c7 c6 c8 53 00 00 	mov    $0x53c8,%rsi
    2585:	bf 01 00 00 00       	mov    $0x1,%edi
    258a:	b8 00 00 00 00       	mov    $0x0,%eax
    258f:	e8 d6 1a 00 00       	call   406a <printf>
      exit();
    ...
    25cb:	48 c7 c6 e0 53 00 00 	mov    $0x53e0,%rsi
    25d2:	bf 01 00 00 00       	mov    $0x1,%edi
    25d7:	b8 00 00 00 00       	mov    $0x0,%eax
    25dc:	e8 89 1a 00 00       	call   406a <printf>
        exit();
    ...
    unlink("bigwrite");
    25fa:	48 c7 c7 bf 53 00 00 	mov    $0x53bf,%rdi
  ...
  printf(1, "bigwrite ok\n");
    261a:	48 c7 c6 f2 53 00 00 	mov    $0x53f2,%rsi
    2621:	bf 01 00 00 00       	mov    $0x1,%edi
    2626:	b8 00 00 00 00       	mov    $0x0,%eax
    262b:	e8 3a 1a 00 00       	call   406a <printf>
}
    2630:	90                   	nop
    2631:	c9                   	leave
    2632:	c3                   	ret
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    263f:	48 c7 c6 ff 53 00 00 	mov    $0x53ff,%rsi
    2646:	bf 01 00 00 00       	mov    $0x1,%edi
    264b:	b8 00 00 00 00       	mov    $0x0,%eax
    2650:	e8 15 1a 00 00       	call   406a <printf>

  unlink("bigfile");
    2655:	48 c7 c7 0d 54 00 00 	mov    $0x540d,%rdi
    265c:	e8 9f 18 00 00       	call   3f00 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2661:	be 02 02 00 00       	mov    $0x202,%esi
    2666:	48 c7 c7 0d 54 00 00 	mov    $0x540d,%rdi
  ...
  if(fd < 0){
    ...
    267b:	48 c7 c6 15 54 00 00 	mov    $0x5415,%rsi
    2682:	bf 01 00 00 00       	mov    $0x1,%edi
    2687:	b8 00 00 00 00       	mov    $0x0,%eax
    268c:	e8 d9 19 00 00       	call   406a <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    26d2:	48 c7 c6 2b 54 00 00 	mov    $0x542b,%rsi
    26d9:	bf 01 00 00 00       	mov    $0x1,%edi
    26de:	b8 00 00 00 00       	mov    $0x0,%eax
    26e3:	e8 82 19 00 00       	call   406a <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    2706:	48 c7 c7 0d 54 00 00 	mov    $0x540d,%rdi
  ...
  if(fd < 0){
    ...
    271b:	48 c7 c6 41 54 00 00 	mov    $0x5441,%rsi
    2722:	bf 01 00 00 00       	mov    $0x1,%edi
    2727:	b8 00 00 00 00       	mov    $0x0,%eax
    272c:	e8 39 19 00 00       	call   406a <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    2763:	48 c7 c6 56 54 00 00 	mov    $0x5456,%rsi
    276a:	bf 01 00 00 00       	mov    $0x1,%edi
    276f:	b8 00 00 00 00       	mov    $0x0,%eax
    2774:	e8 f1 18 00 00       	call   406a <printf>
      exit();
    ...
    2791:	48 c7 c6 6b 54 00 00 	mov    $0x546b,%rsi
    2798:	bf 01 00 00 00       	mov    $0x1,%edi
    279d:	b8 00 00 00 00       	mov    $0x0,%eax
    27a2:	e8 c3 18 00 00       	call   406a <printf>
      exit();
    ...
    27e0:	48 c7 c6 7f 54 00 00 	mov    $0x547f,%rsi
    27e7:	bf 01 00 00 00       	mov    $0x1,%edi
    27ec:	b8 00 00 00 00       	mov    $0x0,%eax
    27f1:	e8 74 18 00 00       	call   406a <printf>
      exit();
...
fourteen(void)
{
  ...
  if(fd < 0){
    ...
    28f0:	48 c7 c6 80 55 00 00 	mov    $0x5580,%rsi
    28f7:	bf 01 00 00 00       	mov    $0x1,%edi
    28fc:	b8 00 00 00 00       	mov    $0x0,%eax
    2901:	e8 64 17 00 00       	call   406a <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    291a:	48 c7 c7 c0 55 00 00 	mov    $0x55c0,%rdi
  ...
  if(fd < 0){
    ...
    292f:	48 c7 c6 f0 55 00 00 	mov    $0x55f0,%rsi
    2936:	bf 01 00 00 00       	mov    $0x1,%edi
    293b:	b8 00 00 00 00       	mov    $0x0,%eax
    2940:	e8 25 17 00 00       	call   406a <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2b5e:	48 c7 c6 99 57 00 00 	mov    $0x5799,%rsi
    2b65:	bf 01 00 00 00       	mov    $0x1,%edi
    2b6a:	b8 00 00 00 00       	mov    $0x0,%eax
    2b6f:	e8 f6 14 00 00       	call   406a <printf>

  fd = open("dirfile", O_CREATE);
    2b74:	be 00 02 00 00       	mov    $0x200,%esi
    2b79:	48 c7 c7 a6 57 00 00 	mov    $0x57a6,%rdi
  ...
  if(fd < 0){
    ...
    2b8e:	48 c7 c6 ae 57 00 00 	mov    $0x57ae,%rsi
    2b95:	bf 01 00 00 00       	mov    $0x1,%edi
    2b9a:	b8 00 00 00 00       	mov    $0x0,%eax
    2b9f:	e8 c6 14 00 00       	call   406a <printf>
    exit();
  ...
  fd = open(".", O_RDWR);
    ...
    2d00:	48 c7 c7 fb 4d 00 00 	mov    $0x4dfb,%rdi
  ...
  printf(1, "dir vs file OK\n");
    2d83:	48 c7 c6 bb 58 00 00 	mov    $0x58bb,%rsi
    2d8a:	bf 01 00 00 00       	mov    $0x1,%edi
    2d8f:	b8 00 00 00 00       	mov    $0x0,%eax
    2d94:	e8 d1 12 00 00       	call   406a <printf>
}
    2d99:	90                   	nop
    2d9a:	c9                   	leave
    2d9b:	c3                   	ret
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2da8:	48 c7 c6 cb 58 00 00 	mov    $0x58cb,%rsi
    2daf:	bf 01 00 00 00       	mov    $0x1,%edi
    2db4:	b8 00 00 00 00       	mov    $0x0,%eax
    2db9:	e8 ac 12 00 00       	call   406a <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2e68:	48 c7 c7 0b 59 00 00 	mov    $0x590b,%rdi
    ...
    unlink("xx");
    2e87:	48 c7 c7 0b 59 00 00 	mov    $0x590b,%rdi
  ...
  chdir("/");
    2ea1:	48 c7 c7 2a 57 00 00 	mov    $0x572a,%rdi
    2ea8:	e8 73 10 00 00       	call   3f20 <chdir>
  printf(1, "empty file name OK\n");
    2ead:	48 c7 c6 0e 59 00 00 	mov    $0x590e,%rsi
    2eb4:	bf 01 00 00 00       	mov    $0x1,%edi
    2eb9:	b8 00 00 00 00       	mov    $0x0,%eax
    2ebe:	e8 a7 11 00 00       	call   406a <printf>
}
    2ec3:	90                   	nop
    2ec4:	c9                   	leave
    2ec5:	c3                   	ret
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2ed2:	48 c7 c6 22 59 00 00 	mov    $0x5922,%rsi
    2ed9:	bf 01 00 00 00       	mov    $0x1,%edi
    2ede:	b8 00 00 00 00       	mov    $0x0,%eax
    2ee3:	e8 82 11 00 00       	call   406a <printf>
  ...
  if(n == 1000){
    ...
    2f23:	48 c7 c6 30 59 00 00 	mov    $0x5930,%rsi
    2f2a:	bf 01 00 00 00       	mov    $0x1,%edi
    2f2f:	b8 00 00 00 00       	mov    $0x0,%eax
    2f34:	e8 31 11 00 00       	call   406a <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2f47:	48 c7 c6 52 59 00 00 	mov    $0x5952,%rsi
    2f4e:	bf 01 00 00 00       	mov    $0x1,%edi
    2f53:	b8 00 00 00 00       	mov    $0x0,%eax
    2f58:	e8 0d 11 00 00       	call   406a <printf>
      exit();
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2fbf:	48 c7 c6 87 59 00 00 	mov    $0x5987,%rsi
    2fc6:	89 c7                	mov    %eax,%edi
    2fc8:	b8 00 00 00 00       	mov    $0x0,%eax
    2fcd:	e8 98 10 00 00       	call   406a <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    3023:	48 c7 c6 92 59 00 00 	mov    $0x5992,%rsi
    302a:	89 c7                	mov    %eax,%edi
    302c:	b8 00 00 00 00       	mov    $0x0,%eax
    3031:	e8 34 10 00 00       	call   406a <printf>
      exit();
  ...
  if(pid < 0){
    ...
    306f:	48 c7 c6 ad 59 00 00 	mov    $0x59ad,%rsi
    3076:	89 c7                	mov    %eax,%edi
    3078:	b8 00 00 00 00       	mov    $0x0,%eax
    307d:	e8 e8 0f 00 00       	call   406a <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    30b7:	48 c7 c6 c4 59 00 00 	mov    $0x59c4,%rsi
    30be:	89 c7                	mov    %eax,%edi
    30c0:	b8 00 00 00 00       	mov    $0x0,%eax
    30c5:	e8 a0 0f 00 00       	call   406a <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    311b:	48 c7 c6 e0 59 00 00 	mov    $0x59e0,%rsi
    3122:	89 c7                	mov    %eax,%edi
    3124:	b8 00 00 00 00       	mov    $0x0,%eax
    3129:	e8 3c 0f 00 00       	call   406a <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    316f:	48 c7 c6 1e 5a 00 00 	mov    $0x5a1e,%rsi
    3176:	89 c7                	mov    %eax,%edi
    3178:	b8 00 00 00 00       	mov    $0x0,%eax
    317d:	e8 e8 0e 00 00       	call   406a <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    31b3:	48 c7 c6 40 5a 00 00 	mov    $0x5a40,%rsi
    31ba:	89 c7                	mov    %eax,%edi
    31bc:	b8 00 00 00 00       	mov    $0x0,%eax
    31c1:	e8 a4 0e 00 00       	call   406a <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3219:	48 c7 c6 78 5a 00 00 	mov    $0x5a78,%rsi
    3220:	89 c7                	mov    %eax,%edi
    3222:	b8 00 00 00 00       	mov    $0x0,%eax
    3227:	e8 3e 0e 00 00       	call   406a <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3242:	48 c7 c6 a0 5a 00 00 	mov    $0x5aa0,%rsi
    3249:	89 c7                	mov    %eax,%edi
    324b:	b8 00 00 00 00       	mov    $0x0,%eax
    3250:	e8 15 0e 00 00       	call   406a <printf>
    exit();
  ...
  if(c != a){
    ...
    329e:	48 c7 c6 d0 5a 00 00 	mov    $0x5ad0,%rsi
    32a5:	89 c7                	mov    %eax,%edi
    32a7:	b8 00 00 00 00       	mov    $0x0,%eax
    32ac:	e8 b9 0d 00 00       	call   406a <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    32dc:	48 c7 c6 71 4a 00 00 	mov    $0x4a71,%rsi
    32e3:	89 c7                	mov    %eax,%edi
    32e5:	b8 00 00 00 00       	mov    $0x0,%eax
    32ea:	e8 7b 0d 00 00       	call   406a <printf>
      exit();
    ...
    330e:	48 c7 c6 f1 5a 00 00 	mov    $0x5af1,%rsi
    3315:	89 c7                	mov    %eax,%edi
    3317:	b8 00 00 00 00       	mov    $0x0,%eax
    331c:	e8 49 0d 00 00       	call   406a <printf>
      kill(ppid);
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    335b:	48 c7 c6 c5 49 00 00 	mov    $0x49c5,%rsi
    3362:	bf 01 00 00 00       	mov    $0x1,%edi
    3367:	b8 00 00 00 00       	mov    $0x0,%eax
    336c:	e8 f9 0c 00 00       	call   406a <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    33c0:	48 c7 c6 2a 4a 00 00 	mov    $0x4a2a,%rsi
  ...
  if(c == (char*)0xffffffff){
    ...
    346b:	48 c7 c6 0a 5b 00 00 	mov    $0x5b0a,%rsi
    3472:	89 c7                	mov    %eax,%edi
    3474:	b8 00 00 00 00       	mov    $0x0,%eax
    3479:	e8 ec 0b 00 00       	call   406a <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    34b3:	48 c7 c6 25 5b 00 00 	mov    $0x5b25,%rsi
    34ba:	89 c7                	mov    %eax,%edi
    34bc:	b8 00 00 00 00       	mov    $0x0,%eax
    34c1:	e8 a4 0b 00 00       	call   406a <printf>
}
    34c6:	90                   	nop
    34c7:	c9                   	leave
    34c8:	c3                   	ret
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    34ee:	48 c7 c6 33 5b 00 00 	mov    $0x5b33,%rsi
    34f5:	89 c7                	mov    %eax,%edi
    34f7:	b8 00 00 00 00       	mov    $0x0,%eax
    34fc:	e8 69 0b 00 00       	call   406a <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3558:	48 c7 c7 42 5b 00 00 	mov    $0x5b42,%rdi
    ...
    356f:	48 c7 c6 4d 5b 00 00 	mov    $0x5b4d,%rsi
    3576:	89 c7                	mov    %eax,%edi
    3578:	b8 00 00 00 00       	mov    $0x0,%eax
    357d:	e8 e8 0a 00 00       	call   406a <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    ...
    35a0:	48 c7 c6 66 5b 00 00 	mov    $0x5b66,%rsi
    35a7:	89 c7                	mov    %eax,%edi
    35a9:	b8 00 00 00 00       	mov    $0x0,%eax
    35ae:	e8 b7 0a 00 00       	call   406a <printf>
}
    35b3:	90                   	nop
    35b4:	c9                   	leave
    35b5:	c3                   	ret
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    ...
    35c8:	48 c7 c6 73 5b 00 00 	mov    $0x5b73,%rsi
    35cf:	89 c7                	mov    %eax,%edi
    35d1:	b8 00 00 00 00       	mov    $0x0,%eax
    35d6:	e8 8f 0a 00 00       	call   406a <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    35fa:	48 c7 c6 7d 5b 00 00 	mov    $0x5b7d,%rsi
    3601:	89 c7                	mov    %eax,%edi
    3603:	b8 00 00 00 00       	mov    $0x0,%eax
    3608:	e8 5d 0a 00 00       	call   406a <printf>
      exit();
  ...
  printf(stdout, "bss test ok\n");
    ...
    3626:	48 c7 c6 8e 5b 00 00 	mov    $0x5b8e,%rsi
    362d:	89 c7                	mov    %eax,%edi
    362f:	b8 00 00 00 00       	mov    $0x0,%eax
    3634:	e8 31 0a 00 00       	call   406a <printf>
}
    3639:	90                   	nop
    363a:	c9                   	leave
    363b:	c3                   	ret
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    3648:	48 c7 c7 9b 5b 00 00 	mov    $0x5b9b,%rdi
  ...
  if(pid == 0){
    ...
    3672:	48 98                	cltq
    3674:	48 c7 04 c5 80 ab 00 	movq   $0x5ba8,0xab80(,%rax,8)
    367b:	00 a8 5b 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    3709:	48 c7 c6 a2 5c 00 00 	mov    $0x5ca2,%rsi
    3710:	89 c7                	mov    %eax,%edi
    3712:	b8 00 00 00 00       	mov    $0x0,%eax
    3717:	e8 4e 09 00 00       	call   406a <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    372b:	48 c7 c7 9b 5b 00 00 	mov    $0x5b9b,%rdi
  ...
  if(fd < 0){
    ...
    3746:	48 c7 c6 bb 5c 00 00 	mov    $0x5cbb,%rsi
    374d:	89 c7                	mov    %eax,%edi
    374f:	b8 00 00 00 00       	mov    $0x0,%eax
    3754:	e8 11 09 00 00       	call   406a <printf>
    exit();
  ...
  unlink("bigarg-ok");
    3768:	48 c7 c7 9b 5b 00 00 	mov    $0x5b9b,%rdi
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    378a:	48 c7 c6 d0 5c 00 00 	mov    $0x5cd0,%rsi
    3791:	bf 01 00 00 00       	mov    $0x1,%edi
    3796:	b8 00 00 00 00       	mov    $0x0,%eax
    379b:	e8 ca 08 00 00       	call   406a <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    388c:	48 c7 c6 dd 5c 00 00 	mov    $0x5cdd,%rsi
    3893:	bf 01 00 00 00       	mov    $0x1,%edi
    3898:	b8 00 00 00 00       	mov    $0x0,%eax
    389d:	e8 c8 07 00 00       	call   406a <printf>
    ...
    38c3:	48 c7 c6 e9 5c 00 00 	mov    $0x5ce9,%rsi
    38ca:	bf 01 00 00 00       	mov    $0x1,%edi
    38cf:	b8 00 00 00 00       	mov    $0x0,%eax
    38d4:	e8 91 07 00 00       	call   406a <printf>
      break;
    ...
    3916:	48 c7 c6 f9 5c 00 00 	mov    $0x5cf9,%rsi
    391d:	bf 01 00 00 00       	mov    $0x1,%edi
    3922:	b8 00 00 00 00       	mov    $0x0,%eax
    3927:	e8 3e 07 00 00       	call   406a <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3a43:	48 c7 c6 09 5d 00 00 	mov    $0x5d09,%rsi
    3a4a:	bf 01 00 00 00       	mov    $0x1,%edi
    3a4f:	b8 00 00 00 00       	mov    $0x0,%eax
    3a54:	e8 11 06 00 00       	call   406a <printf>
}
    3a59:	90                   	nop
    3a5a:	c9                   	leave
    3a5b:	c3                   	ret
...
putc(int fd, char c)
{
    3f78:	f3 0f 1e fa          	endbr64
    3f7c:	55                   	push   %rbp
    3f7d:	48 89 e5             	mov    %rsp,%rbp
    3f80:	48 83 ec 10          	sub    $0x10,%rsp
    3f84:	89 7d fc             	mov    %edi,-0x4(%rbp)
    3f87:	89 f0                	mov    %esi,%eax
    3f89:	88 45 f8             	mov    %al,-0x8(%rbp)
  write(fd, &c, 1);
    3f8c:	48 8d 4d f8          	lea    -0x8(%rbp),%rcx
    3f90:	8b 45 fc             	mov    -0x4(%rbp),%eax
    3f93:	ba 01 00 00 00       	mov    $0x1,%edx
    3f98:	48 89 ce             	mov    %rcx,%rsi
    3f9b:	89 c7                	mov    %eax,%edi
    3f9d:	e8 2e ff ff ff       	call   3ed0 <write>
}
    3fa2:	90                   	nop
    3fa3:	c9                   	leave
    3fa4:	c3                   	ret

0000000000003fa5 <printint>:
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    3fad:	48 83 ec 30          	sub    $0x30,%rsp
    3fb1:	89 7d dc             	mov    %edi,-0x24(%rbp)
    3fb4:	89 75 d8             	mov    %esi,-0x28(%rbp)
    3fb7:	89 55 d4             	mov    %edx,-0x2c(%rbp)
    3fba:	89 4d d0             	mov    %ecx,-0x30(%rbp)
  ...
  neg = 0;
    3fbd:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
  if(sgn && xx < 0){
    3fc4:	83 7d d0 00          	cmpl   $0x0,-0x30(%rbp)
    3fc8:	74 17                	je     3fe1 <printint+0x3c>
    3fca:	83 7d d8 00          	cmpl   $0x0,-0x28(%rbp)
    3fce:	79 11                	jns    3fe1 <printint+0x3c>
    neg = 1;
    3fd0:	c7 45 f8 01 00 00 00 	movl   $0x1,-0x8(%rbp)
    x = -xx;
    3fd7:	8b 45 d8             	mov    -0x28(%rbp),%eax
    3fda:	f7 d8                	neg    %eax
    3fdc:	89 45 f4             	mov    %eax,-0xc(%rbp)
    3fdf:	eb 06                	jmp    3fe7 <printint+0x42>
  } else {
    x = xx;
    3fe1:	8b 45 d8             	mov    -0x28(%rbp),%eax
    3fe4:	89 45 f4             	mov    %eax,-0xc(%rbp)
  }

  i = 0;
    3fe7:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
  do{
    buf[i++] = digits[x % base];
    3fee:	8b 75 d4             	mov    -0x2c(%rbp),%esi
    3ff1:	8b 45 f4             	mov    -0xc(%rbp),%eax
    3ff4:	ba 00 00 00 00       	mov    $0x0,%edx
    3ff9:	f7 f6                	div    %esi
    3ffb:	89 d1                	mov    %edx,%ecx
    3ffd:	8b 45 fc             	mov    -0x4(%rbp),%eax
    4000:	8d 50 01             	lea    0x1(%rax),%edx
    4003:	89 55 fc             	mov    %edx,-0x4(%rbp)
    4006:	89 ca                	mov    %ecx,%edx
    4008:	0f b6 92 20 64 00 00 	movzbl 0x6420(%rdx),%edx
    400f:	48 98                	cltq
    4011:	88 54 05 e0          	mov    %dl,-0x20(%rbp,%rax,1)
  }while((x /= base) != 0);
    4015:	8b 7d d4             	mov    -0x2c(%rbp),%edi
    4018:	8b 45 f4             	mov    -0xc(%rbp),%eax
    401b:	ba 00 00 00 00       	mov    $0x0,%edx
    4020:	f7 f7                	div    %edi
    4022:	89 45 f4             	mov    %eax,-0xc(%rbp)
    4025:	83 7d f4 00          	cmpl   $0x0,-0xc(%rbp)
    4029:	75 c3                	jne    3fee <printint+0x49>
  if(neg)
    402b:	83 7d f8 00          	cmpl   $0x0,-0x8(%rbp)
    402f:	74 2b                	je     405c <printint+0xb7>
    buf[i++] = '-';
    4031:	8b 45 fc             	mov    -0x4(%rbp),%eax
    4034:	8d 50 01             	lea    0x1(%rax),%edx
    4037:	89 55 fc             	mov    %edx,-0x4(%rbp)
    403a:	48 98                	cltq
    403c:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%rbp,%rax,1)

  while(--i >= 0)
    4041:	eb 19                	jmp    405c <printint+0xb7>
    putc(fd, buf[i]);
    4043:	8b 45 fc             	mov    -0x4(%rbp),%eax
    4046:	48 98                	cltq
    4048:	0f b6 44 05 e0       	movzbl -0x20(%rbp,%rax,1),%eax
    404d:	0f be d0             	movsbl %al,%edx
    4050:	8b 45 dc             	mov    -0x24(%rbp),%eax
    4053:	89 d6                	mov    %edx,%esi
    4055:	89 c7                	mov    %eax,%edi
    4057:	e8 1c ff ff ff       	call   3f78 <putc>
  while(--i >= 0)
    405c:	83 6d fc 01          	subl   $0x1,-0x4(%rbp)
    4060:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
    4064:	79 dd                	jns    4043 <printint+0x9e>
}
    4066:	90                   	nop
    4067:	90                   	nop
    4068:	c9                   	leave
...
printf(int fd, char *fmt, ...)
{
    ...
    4072:	48 81 ec f0 00 00 00 	sub    $0xf0,%rsp
    4079:	89 bd 1c ff ff ff    	mov    %edi,-0xe4(%rbp)
    407f:	48 89 b5 10 ff ff ff 	mov    %rsi,-0xf0(%rbp)
    4086:	48 89 95 60 ff ff ff 	mov    %rdx,-0xa0(%rbp)
    408d:	48 89 8d 68 ff ff ff 	mov    %rcx,-0x98(%rbp)
    4094:	4c 89 85 70 ff ff ff 	mov    %r8,-0x90(%rbp)
    409b:	4c 89 8d 78 ff ff ff 	mov    %r9,-0x88(%rbp)
    40a2:	84 c0                	test   %al,%al
    40a4:	74 20                	je     40c6 <printf+0x5c>
    40a6:	0f 29 45 80          	movaps %xmm0,-0x80(%rbp)
    40aa:	0f 29 4d 90          	movaps %xmm1,-0x70(%rbp)
    40ae:	0f 29 55 a0          	movaps %xmm2,-0x60(%rbp)
    40b2:	0f 29 5d b0          	movaps %xmm3,-0x50(%rbp)
    40b6:	0f 29 65 c0          	movaps %xmm4,-0x40(%rbp)
    40ba:	0f 29 6d d0          	movaps %xmm5,-0x30(%rbp)
    40be:	0f 29 75 e0          	movaps %xmm6,-0x20(%rbp)
    40c2:	0f 29 7d f0          	movaps %xmm7,-0x10(%rbp)
  va_list ap;
  char *s;
  int c, i, state;
  va_start(ap, fmt);
    40c6:	c7 85 20 ff ff ff 10 	movl   $0x10,-0xe0(%rbp)
    40cd:	00 00 00 
    40d0:	c7 85 24 ff ff ff 30 	movl   $0x30,-0xdc(%rbp)
    40d7:	00 00 00 
    40da:	48 8d 45 10          	lea    0x10(%rbp),%rax
    40de:	48 89 85 28 ff ff ff 	mov    %rax,-0xd8(%rbp)
    40e5:	48 8d 85 50 ff ff ff 	lea    -0xb0(%rbp),%rax
    40ec:	48 89 85 30 ff ff ff 	mov    %rax,-0xd0(%rbp)

  state = 0;
    40f3:	c7 85 40 ff ff ff 00 	movl   $0x0,-0xc0(%rbp)
    40fa:	00 00 00 
  for(i = 0; fmt[i]; i++){
    40fd:	c7 85 44 ff ff ff 00 	movl   $0x0,-0xbc(%rbp)
    4104:	00 00 00 
    4107:	e9 a8 02 00 00       	jmp    43b4 <printf+0x34a>
    c = fmt[i] & 0xff;
    410c:	8b 85 44 ff ff ff    	mov    -0xbc(%rbp),%eax
    4112:	48 63 d0             	movslq %eax,%rdx
    4115:	48 8b 85 10 ff ff ff 	mov    -0xf0(%rbp),%rax
    411c:	48 01 d0             	add    %rdx,%rax
    411f:	0f b6 00             	movzbl (%rax),%eax
    4122:	0f be c0             	movsbl %al,%eax
    4125:	25 ff 00 00 00       	and    $0xff,%eax
    412a:	89 85 3c ff ff ff    	mov    %eax,-0xc4(%rbp)
    if(state == 0){
    4130:	83 bd 40 ff ff ff 00 	cmpl   $0x0,-0xc0(%rbp)
    4137:	75 35                	jne    416e <printf+0x104>
      if(c == '%'){
    4139:	83 bd 3c ff ff ff 25 	cmpl   $0x25,-0xc4(%rbp)
    4140:	75 0f                	jne    4151 <printf+0xe7>
        state = '%';
    4142:	c7 85 40 ff ff ff 25 	movl   $0x25,-0xc0(%rbp)
    4149:	00 00 00 
    414c:	e9 5c 02 00 00       	jmp    43ad <printf+0x343>
      } else {
        putc(fd, c);
    4151:	8b 85 3c ff ff ff    	mov    -0xc4(%rbp),%eax
    4157:	0f be d0             	movsbl %al,%edx
    415a:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
    4160:	89 d6                	mov    %edx,%esi
    4162:	89 c7                	mov    %eax,%edi
    4164:	e8 0f fe ff ff       	call   3f78 <putc>
    4169:	e9 3f 02 00 00       	jmp    43ad <printf+0x343>
      }
    } else if(state == '%'){
    416e:	83 bd 40 ff ff ff 25 	cmpl   $0x25,-0xc0(%rbp)
    4175:	0f 85 32 02 00 00    	jne    43ad <printf+0x343>
      if(c == 'd'){
    417b:	83 bd 3c ff ff ff 64 	cmpl   $0x64,-0xc4(%rbp)
    4182:	75 5e                	jne    41e2 <printf+0x178>
        printint(fd, va_arg(ap, int), 10, 1);
    4184:	8b 85 20 ff ff ff    	mov    -0xe0(%rbp),%eax
    418a:	83 f8 2f             	cmp    $0x2f,%eax
    418d:	77 23                	ja     41b2 <printf+0x148>
    418f:	48 8b 85 30 ff ff ff 	mov    -0xd0(%rbp),%rax
    4196:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
    419c:	89 d2                	mov    %edx,%edx
    419e:	48 01 d0             	add    %rdx,%rax
    41a1:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
    41a7:	83 c2 08             	add    $0x8,%edx
    41aa:	89 95 20 ff ff ff    	mov    %edx,-0xe0(%rbp)
    41b0:	eb 12                	jmp    41c4 <printf+0x15a>
    41b2:	48 8b 85 28 ff ff ff 	mov    -0xd8(%rbp),%rax
    41b9:	48 8d 50 08          	lea    0x8(%rax),%rdx
    41bd:	48 89 95 28 ff ff ff 	mov    %rdx,-0xd8(%rbp)
    41c4:	8b 30                	mov    (%rax),%esi
    41c6:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
    41cc:	b9 01 00 00 00       	mov    $0x1,%ecx
    41d1:	ba 0a 00 00 00       	mov    $0xa,%edx
    41d6:	89 c7                	mov    %eax,%edi
    41d8:	e8 c8 fd ff ff       	call   3fa5 <printint>
    41dd:	e9 c1 01 00 00       	jmp    43a3 <printf+0x339>
      } else if(c == 'x' || c == 'p'){
    41e2:	83 bd 3c ff ff ff 78 	cmpl   $0x78,-0xc4(%rbp)
    41e9:	74 09                	je     41f4 <printf+0x18a>
    41eb:	83 bd 3c ff ff ff 70 	cmpl   $0x70,-0xc4(%rbp)
    41f2:	75 5e                	jne    4252 <printf+0x1e8>
        printint(fd, va_arg(ap, int), 16, 0);
    41f4:	8b 85 20 ff ff ff    	mov    -0xe0(%rbp),%eax
    41fa:	83 f8 2f             	cmp    $0x2f,%eax
    41fd:	77 23                	ja     4222 <printf+0x1b8>
    41ff:	48 8b 85 30 ff ff ff 	mov    -0xd0(%rbp),%rax
    4206:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
    420c:	89 d2                	mov    %edx,%edx
    420e:	48 01 d0             	add    %rdx,%rax
    4211:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
    4217:	83 c2 08             	add    $0x8,%edx
    421a:	89 95 20 ff ff ff    	mov    %edx,-0xe0(%rbp)
    4220:	eb 12                	jmp    4234 <printf+0x1ca>
    4222:	48 8b 85 28 ff ff ff 	mov    -0xd8(%rbp),%rax
    4229:	48 8d 50 08          	lea    0x8(%rax),%rdx
    422d:	48 89 95 28 ff ff ff 	mov    %rdx,-0xd8(%rbp)
    4234:	8b 30                	mov    (%rax),%esi
    4236:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
    423c:	b9 00 00 00 00       	mov    $0x0,%ecx
    4241:	ba 10 00 00 00       	mov    $0x10,%edx
    4246:	89 c7                	mov    %eax,%edi
    4248:	e8 58 fd ff ff       	call   3fa5 <printint>
    424d:	e9 51 01 00 00       	jmp    43a3 <printf+0x339>
      } else if(c == 's'){
    4252:	83 bd 3c ff ff ff 73 	cmpl   $0x73,-0xc4(%rbp)
    4259:	0f 85 98 00 00 00    	jne    42f7 <printf+0x28d>
        s = va_arg(ap, char*);
    425f:	8b 85 20 ff ff ff    	mov    -0xe0(%rbp),%eax
    4265:	83 f8 2f             	cmp    $0x2f,%eax
    4268:	77 23                	ja     428d <printf+0x223>
    426a:	48 8b 85 30 ff ff ff 	mov    -0xd0(%rbp),%rax
    4271:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
    4277:	89 d2                	mov    %edx,%edx
    4279:	48 01 d0             	add    %rdx,%rax
    427c:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
    4282:	83 c2 08             	add    $0x8,%edx
    4285:	89 95 20 ff ff ff    	mov    %edx,-0xe0(%rbp)
    428b:	eb 12                	jmp    429f <printf+0x235>
    428d:	48 8b 85 28 ff ff ff 	mov    -0xd8(%rbp),%rax
    4294:	48 8d 50 08          	lea    0x8(%rax),%rdx
    4298:	48 89 95 28 ff ff ff 	mov    %rdx,-0xd8(%rbp)
    429f:	48 8b 00             	mov    (%rax),%rax
    42a2:	48 89 85 48 ff ff ff 	mov    %rax,-0xb8(%rbp)
        if(s == 0)
    42a9:	48 83 bd 48 ff ff ff 	cmpq   $0x0,-0xb8(%rbp)
    42b0:	00 
    42b1:	75 31                	jne    42e4 <printf+0x27a>
          s = "(null)";
    42b3:	48 c7 85 48 ff ff ff 	movq   $0x5d72,-0xb8(%rbp)
    42ba:	72 5d 00 00 
        while(*s != 0){
    42be:	eb 24                	jmp    42e4 <printf+0x27a>
          putc(fd, *s);
    42c0:	48 8b 85 48 ff ff ff 	mov    -0xb8(%rbp),%rax
    42c7:	0f b6 00             	movzbl (%rax),%eax
    42ca:	0f be d0             	movsbl %al,%edx
    42cd:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
    42d3:	89 d6                	mov    %edx,%esi
    42d5:	89 c7                	mov    %eax,%edi
    42d7:	e8 9c fc ff ff       	call   3f78 <putc>
          s++;
    42dc:	48 83 85 48 ff ff ff 	addq   $0x1,-0xb8(%rbp)
    42e3:	01 
        while(*s != 0){
    42e4:	48 8b 85 48 ff ff ff 	mov    -0xb8(%rbp),%rax
    42eb:	0f b6 00             	movzbl (%rax),%eax
    42ee:	84 c0                	test   %al,%al
    42f0:	75 ce                	jne    42c0 <printf+0x256>
    42f2:	e9 ac 00 00 00       	jmp    43a3 <printf+0x339>
        }
      } else if(c == 'c'){
    42f7:	83 bd 3c ff ff ff 63 	cmpl   $0x63,-0xc4(%rbp)
    42fe:	75 56                	jne    4356 <printf+0x2ec>
        putc(fd, va_arg(ap, uint));
    4300:	8b 85 20 ff ff ff    	mov    -0xe0(%rbp),%eax
    4306:	83 f8 2f             	cmp    $0x2f,%eax
    4309:	77 23                	ja     432e <printf+0x2c4>
    430b:	48 8b 85 30 ff ff ff 	mov    -0xd0(%rbp),%rax
    4312:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
    4318:	89 d2                	mov    %edx,%edx
    431a:	48 01 d0             	add    %rdx,%rax
    431d:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
    4323:	83 c2 08             	add    $0x8,%edx
    4326:	89 95 20 ff ff ff    	mov    %edx,-0xe0(%rbp)
    432c:	eb 12                	jmp    4340 <printf+0x2d6>
    432e:	48 8b 85 28 ff ff ff 	mov    -0xd8(%rbp),%rax
    4335:	48 8d 50 08          	lea    0x8(%rax),%rdx
    4339:	48 89 95 28 ff ff ff 	mov    %rdx,-0xd8(%rbp)
    4340:	8b 00                	mov    (%rax),%eax
    4342:	0f be d0             	movsbl %al,%edx
    4345:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
    434b:	89 d6                	mov    %edx,%esi
    434d:	89 c7                	mov    %eax,%edi
    434f:	e8 24 fc ff ff       	call   3f78 <putc>
    4354:	eb 4d                	jmp    43a3 <printf+0x339>
      } else if(c == '%'){
    4356:	83 bd 3c ff ff ff 25 	cmpl   $0x25,-0xc4(%rbp)
    435d:	75 1a                	jne    4379 <printf+0x30f>
        putc(fd, c);
    435f:	8b 85 3c ff ff ff    	mov    -0xc4(%rbp),%eax
    4365:	0f be d0             	movsbl %al,%edx
    4368:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
    436e:	89 d6                	mov    %edx,%esi
    4370:	89 c7                	mov    %eax,%edi
    4372:	e8 01 fc ff ff       	call   3f78 <putc>
    4377:	eb 2a                	jmp    43a3 <printf+0x339>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    4379:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
    437f:	be 25 00 00 00       	mov    $0x25,%esi
    4384:	89 c7                	mov    %eax,%edi
    4386:	e8 ed fb ff ff       	call   3f78 <putc>
        putc(fd, c);
    438b:	8b 85 3c ff ff ff    	mov    -0xc4(%rbp),%eax
    4391:	0f be d0             	movsbl %al,%edx
    4394:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
    439a:	89 d6                	mov    %edx,%esi
    439c:	89 c7                	mov    %eax,%edi
    439e:	e8 d5 fb ff ff       	call   3f78 <putc>
      }
      state = 0;
    43a3:	c7 85 40 ff ff ff 00 	movl   $0x0,-0xc0(%rbp)
    43aa:	00 00 00 
  for(i = 0; fmt[i]; i++){
    43ad:	83 85 44 ff ff ff 01 	addl   $0x1,-0xbc(%rbp)
    43b4:	8b 85 44 ff ff ff    	mov    -0xbc(%rbp),%eax
    43ba:	48 63 d0             	movslq %eax,%rdx
    43bd:	48 8b 85 10 ff ff ff 	mov    -0xf0(%rbp),%rax
    43c4:	48 01 d0             	add    %rdx,%rax
    43c7:	0f b6 00             	movzbl (%rax),%eax
    43ca:	84 c0                	test   %al,%al
    43cc:	0f 85 3a fd ff ff    	jne    410c <printf+0xa2>
    }
  }
}
    43d2:	90                   	nop
...
free(void *ap)
{
    43d6:	f3 0f 1e fa          	endbr64
    43da:	55                   	push   %rbp
    43db:	48 89 e5             	mov    %rsp,%rbp
    43de:	48 83 ec 18          	sub    $0x18,%rsp
    43e2:	48 89 7d e8          	mov    %rdi,-0x18(%rbp)
  Header *bp, *p;

  bp = (Header*)ap - 1;
    43e6:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    43ea:	48 83 e8 10          	sub    $0x10,%rax
    43ee:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    43f2:	48 8b 05 97 68 00 00 	mov    0x6897(%rip),%rax        # ac90 <freep>
    43f9:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    43fd:	eb 2f                	jmp    442e <free+0x58>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    43ff:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    4403:	48 8b 00             	mov    (%rax),%rax
    4406:	48 39 45 f8          	cmp    %rax,-0x8(%rbp)
    440a:	72 17                	jb     4423 <free+0x4d>
    440c:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    4410:	48 39 45 f8          	cmp    %rax,-0x8(%rbp)
    4414:	72 2f                	jb     4445 <free+0x6f>
    4416:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    441a:	48 8b 00             	mov    (%rax),%rax
    441d:	48 39 45 f0          	cmp    %rax,-0x10(%rbp)
    4421:	72 22                	jb     4445 <free+0x6f>
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4423:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    4427:	48 8b 00             	mov    (%rax),%rax
    442a:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    442e:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    4432:	48 39 45 f8          	cmp    %rax,-0x8(%rbp)
    4436:	73 c7                	jae    43ff <free+0x29>
    4438:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    443c:	48 8b 00             	mov    (%rax),%rax
    443f:	48 39 45 f0          	cmp    %rax,-0x10(%rbp)
    4443:	73 ba                	jae    43ff <free+0x29>
      break;
  if(bp + bp->s.size == p->s.ptr){
    4445:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    4449:	8b 40 08             	mov    0x8(%rax),%eax
    444c:	89 c0                	mov    %eax,%eax
    444e:	48 c1 e0 04          	shl    $0x4,%rax
    4452:	48 89 c2             	mov    %rax,%rdx
    4455:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    4459:	48 01 c2             	add    %rax,%rdx
    445c:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    4460:	48 8b 00             	mov    (%rax),%rax
    4463:	48 39 c2             	cmp    %rax,%rdx
    4466:	75 2d                	jne    4495 <free+0xbf>
    bp->s.size += p->s.ptr->s.size;
    4468:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    446c:	8b 50 08             	mov    0x8(%rax),%edx
    446f:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    4473:	48 8b 00             	mov    (%rax),%rax
    4476:	8b 40 08             	mov    0x8(%rax),%eax
    4479:	01 c2                	add    %eax,%edx
    447b:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    447f:	89 50 08             	mov    %edx,0x8(%rax)
    bp->s.ptr = p->s.ptr->s.ptr;
    4482:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    4486:	48 8b 00             	mov    (%rax),%rax
    4489:	48 8b 10             	mov    (%rax),%rdx
    448c:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    4490:	48 89 10             	mov    %rdx,(%rax)
    4493:	eb 0e                	jmp    44a3 <free+0xcd>
  } else
    bp->s.ptr = p->s.ptr;
    4495:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    4499:	48 8b 10             	mov    (%rax),%rdx
    449c:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    44a0:	48 89 10             	mov    %rdx,(%rax)
  if(p + p->s.size == bp){
    44a3:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    44a7:	8b 40 08             	mov    0x8(%rax),%eax
    44aa:	89 c0                	mov    %eax,%eax
    44ac:	48 c1 e0 04          	shl    $0x4,%rax
    44b0:	48 89 c2             	mov    %rax,%rdx
    44b3:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    44b7:	48 01 d0             	add    %rdx,%rax
    44ba:	48 39 45 f0          	cmp    %rax,-0x10(%rbp)
    44be:	75 27                	jne    44e7 <free+0x111>
    p->s.size += bp->s.size;
    44c0:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    44c4:	8b 50 08             	mov    0x8(%rax),%edx
    44c7:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    44cb:	8b 40 08             	mov    0x8(%rax),%eax
    44ce:	01 c2                	add    %eax,%edx
    44d0:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    44d4:	89 50 08             	mov    %edx,0x8(%rax)
    p->s.ptr = bp->s.ptr;
    44d7:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    44db:	48 8b 10             	mov    (%rax),%rdx
    44de:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    44e2:	48 89 10             	mov    %rdx,(%rax)
    44e5:	eb 0b                	jmp    44f2 <free+0x11c>
  } else
    p->s.ptr = bp;
    44e7:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    44eb:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    44ef:	48 89 10             	mov    %rdx,(%rax)
  freep = p;
    44f2:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    44f6:	48 89 05 93 67 00 00 	mov    %rax,0x6793(%rip)        # ac90 <freep>
}
    44fd:	90                   	nop
    44fe:	c9                   	leave
    44ff:	c3                   	ret

0000000000004500 <morecore>:
...
morecore(uint nu)
{
    ...
    4508:	48 83 ec 20          	sub    $0x20,%rsp
    450c:	89 7d ec             	mov    %edi,-0x14(%rbp)
  char *p;
  Header *hp;

  if(nu < 4096)
    450f:	81 7d ec ff 0f 00 00 	cmpl   $0xfff,-0x14(%rbp)
    4516:	77 07                	ja     451f <morecore+0x1f>
    nu = 4096;
    4518:	c7 45 ec 00 10 00 00 	movl   $0x1000,-0x14(%rbp)
  p = sbrk(nu * sizeof(Header));
    451f:	8b 45 ec             	mov    -0x14(%rbp),%eax
    4522:	c1 e0 04             	shl    $0x4,%eax
    4525:	89 c7                	mov    %eax,%edi
    4527:	e8 0c fa ff ff       	call   3f38 <sbrk>
    452c:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
  if(p == (char*)-1)
    4530:	48 83 7d f8 ff       	cmpq   $0xffffffffffffffff,-0x8(%rbp)
    4535:	75 07                	jne    453e <morecore+0x3e>
    return 0;
    4537:	b8 00 00 00 00       	mov    $0x0,%eax
    453c:	eb 29                	jmp    4567 <morecore+0x67>
  hp = (Header*)p;
    453e:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    4542:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
  hp->s.size = nu;
    4546:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    454a:	8b 55 ec             	mov    -0x14(%rbp),%edx
    454d:	89 50 08             	mov    %edx,0x8(%rax)
  free((void*)(hp + 1));
    4550:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    4554:	48 83 c0 10          	add    $0x10,%rax
    4558:	48 89 c7             	mov    %rax,%rdi
    455b:	e8 76 fe ff ff       	call   43d6 <free>
  return freep;
    4560:	48 8b 05 29 67 00 00 	mov    0x6729(%rip),%rax        # ac90 <freep>
}
    4567:	c9                   	leave
    4568:	c3                   	ret

0000000000004569 <malloc>:

void*
malloc(uint nbytes)
{
    4569:	f3 0f 1e fa          	endbr64
    456d:	55                   	push   %rbp
    456e:	48 89 e5             	mov    %rsp,%rbp
    4571:	48 83 ec 30          	sub    $0x30,%rsp
    4575:	89 7d dc             	mov    %edi,-0x24(%rbp)
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4578:	8b 45 dc             	mov    -0x24(%rbp),%eax
    457b:	48 83 c0 0f          	add    $0xf,%rax
    457f:	48 c1 e8 04          	shr    $0x4,%rax
    4583:	83 c0 01             	add    $0x1,%eax
    4586:	89 45 ec             	mov    %eax,-0x14(%rbp)
  if((prevp = freep) == 0){
    4589:	48 8b 05 00 67 00 00 	mov    0x6700(%rip),%rax        # ac90 <freep>
    4590:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    4594:	48 83 7d f0 00       	cmpq   $0x0,-0x10(%rbp)
    4599:	75 2b                	jne    45c6 <malloc+0x5d>
    base.s.ptr = freep = prevp = &base;
    459b:	48 c7 45 f0 80 ac 00 	movq   $0xac80,-0x10(%rbp)
    45a2:	00 
    45a3:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    45a7:	48 89 05 e2 66 00 00 	mov    %rax,0x66e2(%rip)        # ac90 <freep>
    45ae:	48 8b 05 db 66 00 00 	mov    0x66db(%rip),%rax        # ac90 <freep>
    45b5:	48 89 05 c4 66 00 00 	mov    %rax,0x66c4(%rip)        # ac80 <base>
    base.s.size = 0;
    45bc:	c7 05 c2 66 00 00 00 	movl   $0x0,0x66c2(%rip)        # ac88 <base+0x8>
    45c3:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    45c6:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    45ca:	48 8b 00             	mov    (%rax),%rax
    45cd:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    if(p->s.size >= nunits){
    45d1:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    45d5:	8b 40 08             	mov    0x8(%rax),%eax
    45d8:	3b 45 ec             	cmp    -0x14(%rbp),%eax
    45db:	72 5f                	jb     463c <malloc+0xd3>
      if(p->s.size == nunits)
    45dd:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    45e1:	8b 40 08             	mov    0x8(%rax),%eax
    45e4:	39 45 ec             	cmp    %eax,-0x14(%rbp)
    45e7:	75 10                	jne    45f9 <malloc+0x90>
        prevp->s.ptr = p->s.ptr;
    45e9:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    45ed:	48 8b 10             	mov    (%rax),%rdx
    45f0:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    45f4:	48 89 10             	mov    %rdx,(%rax)
    45f7:	eb 2e                	jmp    4627 <malloc+0xbe>
      else {
        p->s.size -= nunits;
    45f9:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    45fd:	8b 40 08             	mov    0x8(%rax),%eax
    4600:	2b 45 ec             	sub    -0x14(%rbp),%eax
    4603:	89 c2                	mov    %eax,%edx
    4605:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    4609:	89 50 08             	mov    %edx,0x8(%rax)
        p += p->s.size;
    460c:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    4610:	8b 40 08             	mov    0x8(%rax),%eax
    4613:	89 c0                	mov    %eax,%eax
    4615:	48 c1 e0 04          	shl    $0x4,%rax
    4619:	48 01 45 f8          	add    %rax,-0x8(%rbp)
        p->s.size = nunits;
    461d:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    4621:	8b 55 ec             	mov    -0x14(%rbp),%edx
    4624:	89 50 08             	mov    %edx,0x8(%rax)
      }
      freep = prevp;
    4627:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    462b:	48 89 05 5e 66 00 00 	mov    %rax,0x665e(%rip)        # ac90 <freep>
      return (void*)(p + 1);
    4632:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    4636:	48 83 c0 10          	add    $0x10,%rax
    463a:	eb 41                	jmp    467d <malloc+0x114>
    }
    if(p == freep)
    463c:	48 8b 05 4d 66 00 00 	mov    0x664d(%rip),%rax        # ac90 <freep>
    4643:	48 39 45 f8          	cmp    %rax,-0x8(%rbp)
    4647:	75 1c                	jne    4665 <malloc+0xfc>
      if((p = morecore(nunits)) == 0)
    4649:	8b 45 ec             	mov    -0x14(%rbp),%eax
    464c:	89 c7                	mov    %eax,%edi
    464e:	e8 ad fe ff ff       	call   4500 <morecore>
    4653:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    4657:	48 83 7d f8 00       	cmpq   $0x0,-0x8(%rbp)
    465c:	75 07                	jne    4665 <malloc+0xfc>
        return 0;
    465e:	b8 00 00 00 00       	mov    $0x0,%eax
    4663:	eb 18                	jmp    467d <malloc+0x114>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4665:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    4669:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    466d:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    4671:	48 8b 00             	mov    (%rax),%rax
    4674:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    if(p->s.size >= nunits){
    4678:	e9 54 ff ff ff       	jmp    45d1 <malloc+0x68>
  }
}
    467d:	c9                   	leave
    467e:	c3                   	ret
