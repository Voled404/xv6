...
main(int argc, char *argv[])
{
  ...
  57:	e8 ae 03 00 00       	call   40a <unlink>
  ...
  7a:	48 c7 c6 a5 0b 00 00 	mov    $0xba5,%rsi
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 51a:	0f b6 92 00 0e 00 00 	movzbl 0xe00(%rdx),%edx
 521:	48 98                	cltq
...
printf(int fd, char *fmt, ...)
{
 ...
 7c3:	75 31                	jne    7f6 <printf+0x27a>
          s = "(null)";
 7c5:	48 c7 85 48 ff ff ff 	movq   $0xbbe,-0xb8(%rbp)
 7cc:	be 0b 00 00 
        while(*s != 0){
...
free(void *ap)
{
 ...
 904:	48 8b 05 25 05 00 00 	mov    0x525(%rip),%rax        # e30 <freep>
 ...
 a08:	48 89 05 21 04 00 00 	mov    %rax,0x421(%rip)        # e30 <freep>
}
 a0f:	90                   	nop
 a10:	c9                   	leave
 a11:	c3                   	ret
...
morecore(uint nu)
{
 ...
 a6d:	e8 76 fe ff ff       	call   8e8 <free>
  return freep;
 a72:	48 8b 05 b7 03 00 00 	mov    0x3b7(%rip),%rax        # e30 <freep>
}
 a79:	c9                   	leave
 a7a:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 a98:	89 45 ec             	mov    %eax,-0x14(%rbp)
  if((prevp = freep) == 0){
 a9b:	48 8b 05 8e 03 00 00 	mov    0x38e(%rip),%rax        # e30 <freep>
 aa2:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
 aa6:	48 83 7d f0 00       	cmpq   $0x0,-0x10(%rbp)
 aab:	75 2b                	jne    ad8 <malloc+0x5d>
    base.s.ptr = freep = prevp = &base;
 aad:	48 c7 45 f0 20 0e 00 	movq   $0xe20,-0x10(%rbp)
 ab4:	00 
 ab5:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
 ab9:	48 89 05 70 03 00 00 	mov    %rax,0x370(%rip)        # e30 <freep>
 ac0:	48 8b 05 69 03 00 00 	mov    0x369(%rip),%rax        # e30 <freep>
 ac7:	48 89 05 52 03 00 00 	mov    %rax,0x352(%rip)        # e20 <base>
    base.s.size = 0;
 ace:	c7 05 50 03 00 00 00 	movl   $0x0,0x350(%rip)        # e28 <base+0x8>
 ad5:	00 00 00 
  }
 ...
 b3d:	48 89 05 ec 02 00 00 	mov    %rax,0x2ec(%rip)        # e30 <freep>
      return (void*)(p + 1);
 ...
 b4c:	eb 41                	jmp    b8f <malloc+0x114>
    ...
    if(p == freep)
 b4e:	48 8b 05 db 02 00 00 	mov    0x2db(%rip),%rax        # e30 <freep>
