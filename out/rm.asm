...
main(int argc, char *argv[])
{
  ...
  7a:	48 c7 c6 85 0b 00 00 	mov    $0xb85,%rsi
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4fa:	0f b6 92 e0 0d 00 00 	movzbl 0xde0(%rdx),%edx
 501:	48 98                	cltq
...
printf(int fd, char *fmt, ...)
{
 ...
 7a3:	75 31                	jne    7d6 <printf+0x27a>
          s = "(null)";
 7a5:	48 c7 85 48 ff ff ff 	movq   $0xb9e,-0xb8(%rbp)
 7ac:	9e 0b 00 00 
        while(*s != 0){
...
free(void *ap)
{
 ...
 8e4:	48 8b 05 25 05 00 00 	mov    0x525(%rip),%rax        # e10 <freep>
 ...
 9e8:	48 89 05 21 04 00 00 	mov    %rax,0x421(%rip)        # e10 <freep>
}
 9ef:	90                   	nop
 9f0:	c9                   	leave
 9f1:	c3                   	ret
...
morecore(uint nu)
{
 ...
 a4d:	e8 76 fe ff ff       	call   8c8 <free>
  return freep;
 a52:	48 8b 05 b7 03 00 00 	mov    0x3b7(%rip),%rax        # e10 <freep>
}
 a59:	c9                   	leave
 a5a:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 a78:	89 45 ec             	mov    %eax,-0x14(%rbp)
  if((prevp = freep) == 0){
 a7b:	48 8b 05 8e 03 00 00 	mov    0x38e(%rip),%rax        # e10 <freep>
 a82:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
 a86:	48 83 7d f0 00       	cmpq   $0x0,-0x10(%rbp)
 a8b:	75 2b                	jne    ab8 <malloc+0x5d>
    base.s.ptr = freep = prevp = &base;
 a8d:	48 c7 45 f0 00 0e 00 	movq   $0xe00,-0x10(%rbp)
 a94:	00 
 a95:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
 a99:	48 89 05 70 03 00 00 	mov    %rax,0x370(%rip)        # e10 <freep>
 aa0:	48 8b 05 69 03 00 00 	mov    0x369(%rip),%rax        # e10 <freep>
 aa7:	48 89 05 52 03 00 00 	mov    %rax,0x352(%rip)        # e00 <base>
    base.s.size = 0;
 aae:	c7 05 50 03 00 00 00 	movl   $0x0,0x350(%rip)        # e08 <base+0x8>
 ab5:	00 00 00 
  }
 ...
 b1d:	48 89 05 ec 02 00 00 	mov    %rax,0x2ec(%rip)        # e10 <freep>
      return (void*)(p + 1);
 ...
 b2c:	eb 41                	jmp    b6f <malloc+0x114>
    ...
    if(p == freep)
 b2e:	48 8b 05 db 02 00 00 	mov    0x2db(%rip),%rax        # e10 <freep>
