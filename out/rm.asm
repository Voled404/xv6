...
main(int argc, char *argv[])
{
  ...
  7a:	48 c7 c6 95 0b 00 00 	mov    $0xb95,%rsi
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 50a:	0f b6 92 f0 0d 00 00 	movzbl 0xdf0(%rdx),%edx
 511:	48 98                	cltq
...
printf(int fd, char *fmt, ...)
{
 ...
 7b3:	75 31                	jne    7e6 <printf+0x27a>
          s = "(null)";
 7b5:	48 c7 85 48 ff ff ff 	movq   $0xbae,-0xb8(%rbp)
 7bc:	ae 0b 00 00 
        while(*s != 0){
...
free(void *ap)
{
 ...
 8f4:	48 8b 05 25 05 00 00 	mov    0x525(%rip),%rax        # e20 <freep>
 ...
 9f8:	48 89 05 21 04 00 00 	mov    %rax,0x421(%rip)        # e20 <freep>
}
 9ff:	90                   	nop
 a00:	c9                   	leave
 a01:	c3                   	ret
...
morecore(uint nu)
{
 ...
 a5d:	e8 76 fe ff ff       	call   8d8 <free>
  return freep;
 a62:	48 8b 05 b7 03 00 00 	mov    0x3b7(%rip),%rax        # e20 <freep>
}
 a69:	c9                   	leave
 a6a:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 a88:	89 45 ec             	mov    %eax,-0x14(%rbp)
  if((prevp = freep) == 0){
 a8b:	48 8b 05 8e 03 00 00 	mov    0x38e(%rip),%rax        # e20 <freep>
 a92:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
 a96:	48 83 7d f0 00       	cmpq   $0x0,-0x10(%rbp)
 a9b:	75 2b                	jne    ac8 <malloc+0x5d>
    base.s.ptr = freep = prevp = &base;
 a9d:	48 c7 45 f0 10 0e 00 	movq   $0xe10,-0x10(%rbp)
 aa4:	00 
 aa5:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
 aa9:	48 89 05 70 03 00 00 	mov    %rax,0x370(%rip)        # e20 <freep>
 ab0:	48 8b 05 69 03 00 00 	mov    0x369(%rip),%rax        # e20 <freep>
 ab7:	48 89 05 52 03 00 00 	mov    %rax,0x352(%rip)        # e10 <base>
    base.s.size = 0;
 abe:	c7 05 50 03 00 00 00 	movl   $0x0,0x350(%rip)        # e18 <base+0x8>
 ac5:	00 00 00 
  }
 ...
 b2d:	48 89 05 ec 02 00 00 	mov    %rax,0x2ec(%rip)        # e20 <freep>
      return (void*)(p + 1);
 ...
 b3c:	eb 41                	jmp    b7f <malloc+0x114>
    ...
    if(p == freep)
 b3e:	48 8b 05 db 02 00 00 	mov    0x2db(%rip),%rax        # e20 <freep>
