...
main(void)
{
  ...
  11:	48 c7 c7 ed 0b 00 00 	mov    $0xbed,%rdi
  ...
  2b:	48 c7 c7 ed 0b 00 00 	mov    $0xbed,%rdi
  32:	e8 2c 04 00 00       	call   463 <mknod>
    open("console", O_RDWR);
  37:	be 02 00 00 00       	mov    $0x2,%esi
  3c:	48 c7 c7 ed 0b 00 00 	mov    $0xbed,%rdi
  ...
  5c:	48 c7 c6 f5 0b 00 00 	mov    $0xbf5,%rsi
  63:	bf 01 00 00 00       	mov    $0x1,%edi
  68:	b8 00 00 00 00       	mov    $0x0,%eax
  6d:	e8 63 05 00 00       	call   5d5 <printf>
    pid = fork();
  ...
  80:	48 c7 c6 08 0c 00 00 	mov    $0xc08,%rsi
  87:	bf 01 00 00 00       	mov    $0x1,%edi
  8c:	b8 00 00 00 00       	mov    $0x0,%eax
  91:	e8 3f 05 00 00       	call   5d5 <printf>
      exit();
...
putc(int fd, char c)
{
 4e3:	f3 0f 1e fa          	endbr64
 4e7:	55                   	push   %rbp
 4e8:	48 89 e5             	mov    %rsp,%rbp
 4eb:	48 83 ec 10          	sub    $0x10,%rsp
 4ef:	89 7d fc             	mov    %edi,-0x4(%rbp)
 4f2:	89 f0                	mov    %esi,%eax
 4f4:	88 45 f8             	mov    %al,-0x8(%rbp)
  write(fd, &c, 1);
 4f7:	48 8d 4d f8          	lea    -0x8(%rbp),%rcx
 4fb:	8b 45 fc             	mov    -0x4(%rbp),%eax
 4fe:	ba 01 00 00 00       	mov    $0x1,%edx
 503:	48 89 ce             	mov    %rcx,%rsi
 506:	89 c7                	mov    %eax,%edi
 508:	e8 2e ff ff ff       	call   43b <write>
}
 50d:	90                   	nop
 50e:	c9                   	leave
 50f:	c3                   	ret
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 518:	48 83 ec 30          	sub    $0x30,%rsp
 51c:	89 7d dc             	mov    %edi,-0x24(%rbp)
 51f:	89 75 d8             	mov    %esi,-0x28(%rbp)
 522:	89 55 d4             	mov    %edx,-0x2c(%rbp)
 525:	89 4d d0             	mov    %ecx,-0x30(%rbp)
  ...
  neg = 0;
 528:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
  if(sgn && xx < 0){
 52f:	83 7d d0 00          	cmpl   $0x0,-0x30(%rbp)
 533:	74 17                	je     54c <printint+0x3c>
 535:	83 7d d8 00          	cmpl   $0x0,-0x28(%rbp)
 539:	79 11                	jns    54c <printint+0x3c>
    neg = 1;
 53b:	c7 45 f8 01 00 00 00 	movl   $0x1,-0x8(%rbp)
    x = -xx;
 542:	8b 45 d8             	mov    -0x28(%rbp),%eax
 545:	f7 d8                	neg    %eax
 547:	89 45 f4             	mov    %eax,-0xc(%rbp)
 54a:	eb 06                	jmp    552 <printint+0x42>
  } else {
    x = xx;
 ...
 54f:	89 45 f4             	mov    %eax,-0xc(%rbp)
  ...
  i = 0;
 552:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
  do{
    buf[i++] = digits[x % base];
 559:	8b 75 d4             	mov    -0x2c(%rbp),%esi
 55c:	8b 45 f4             	mov    -0xc(%rbp),%eax
 55f:	ba 00 00 00 00       	mov    $0x0,%edx
 564:	f7 f6                	div    %esi
 566:	89 d1                	mov    %edx,%ecx
 568:	8b 45 fc             	mov    -0x4(%rbp),%eax
 56b:	8d 50 01             	lea    0x1(%rax),%edx
 56e:	89 55 fc             	mov    %edx,-0x4(%rbp)
 571:	89 ca                	mov    %ecx,%edx
 573:	0f b6 92 90 0e 00 00 	movzbl 0xe90(%rdx),%edx
 57a:	48 98                	cltq
 57c:	88 54 05 e0          	mov    %dl,-0x20(%rbp,%rax,1)
  }while((x /= base) != 0);
 580:	8b 7d d4             	mov    -0x2c(%rbp),%edi
 583:	8b 45 f4             	mov    -0xc(%rbp),%eax
 586:	ba 00 00 00 00       	mov    $0x0,%edx
 58b:	f7 f7                	div    %edi
 58d:	89 45 f4             	mov    %eax,-0xc(%rbp)
 590:	83 7d f4 00          	cmpl   $0x0,-0xc(%rbp)
 594:	75 c3                	jne    559 <printint+0x49>
  if(neg)
 596:	83 7d f8 00          	cmpl   $0x0,-0x8(%rbp)
 59a:	74 2b                	je     5c7 <printint+0xb7>
    buf[i++] = '-';
 59c:	8b 45 fc             	mov    -0x4(%rbp),%eax
 59f:	8d 50 01             	lea    0x1(%rax),%edx
 5a2:	89 55 fc             	mov    %edx,-0x4(%rbp)
 5a5:	48 98                	cltq
 5a7:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%rbp,%rax,1)

  while(--i >= 0)
 5ac:	eb 19                	jmp    5c7 <printint+0xb7>
    putc(fd, buf[i]);
 5ae:	8b 45 fc             	mov    -0x4(%rbp),%eax
 5b1:	48 98                	cltq
 5b3:	0f b6 44 05 e0       	movzbl -0x20(%rbp,%rax,1),%eax
 5b8:	0f be d0             	movsbl %al,%edx
 5bb:	8b 45 dc             	mov    -0x24(%rbp),%eax
 5be:	89 d6                	mov    %edx,%esi
 5c0:	89 c7                	mov    %eax,%edi
 5c2:	e8 1c ff ff ff       	call   4e3 <putc>
  while(--i >= 0)
 5c7:	83 6d fc 01          	subl   $0x1,-0x4(%rbp)
 5cb:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
 5cf:	79 dd                	jns    5ae <printint+0x9e>
}
 5d1:	90                   	nop
 5d2:	90                   	nop
 5d3:	c9                   	leave
...
printf(int fd, char *fmt, ...)
{
 ...
 5dd:	48 81 ec f0 00 00 00 	sub    $0xf0,%rsp
 5e4:	89 bd 1c ff ff ff    	mov    %edi,-0xe4(%rbp)
 5ea:	48 89 b5 10 ff ff ff 	mov    %rsi,-0xf0(%rbp)
 5f1:	48 89 95 60 ff ff ff 	mov    %rdx,-0xa0(%rbp)
 5f8:	48 89 8d 68 ff ff ff 	mov    %rcx,-0x98(%rbp)
 5ff:	4c 89 85 70 ff ff ff 	mov    %r8,-0x90(%rbp)
 606:	4c 89 8d 78 ff ff ff 	mov    %r9,-0x88(%rbp)
 60d:	84 c0                	test   %al,%al
 60f:	74 20                	je     631 <printf+0x5c>
 611:	0f 29 45 80          	movaps %xmm0,-0x80(%rbp)
 615:	0f 29 4d 90          	movaps %xmm1,-0x70(%rbp)
 619:	0f 29 55 a0          	movaps %xmm2,-0x60(%rbp)
 61d:	0f 29 5d b0          	movaps %xmm3,-0x50(%rbp)
 621:	0f 29 65 c0          	movaps %xmm4,-0x40(%rbp)
 625:	0f 29 6d d0          	movaps %xmm5,-0x30(%rbp)
 629:	0f 29 75 e0          	movaps %xmm6,-0x20(%rbp)
 62d:	0f 29 7d f0          	movaps %xmm7,-0x10(%rbp)
  va_list ap;
  char *s;
  int c, i, state;
  va_start(ap, fmt);
 631:	c7 85 20 ff ff ff 10 	movl   $0x10,-0xe0(%rbp)
 638:	00 00 00 
 63b:	c7 85 24 ff ff ff 30 	movl   $0x30,-0xdc(%rbp)
 642:	00 00 00 
 645:	48 8d 45 10          	lea    0x10(%rbp),%rax
 649:	48 89 85 28 ff ff ff 	mov    %rax,-0xd8(%rbp)
 650:	48 8d 85 50 ff ff ff 	lea    -0xb0(%rbp),%rax
 657:	48 89 85 30 ff ff ff 	mov    %rax,-0xd0(%rbp)

  state = 0;
 65e:	c7 85 40 ff ff ff 00 	movl   $0x0,-0xc0(%rbp)
 665:	00 00 00 
  for(i = 0; fmt[i]; i++){
 668:	c7 85 44 ff ff ff 00 	movl   $0x0,-0xbc(%rbp)
 66f:	00 00 00 
 672:	e9 a8 02 00 00       	jmp    91f <printf+0x34a>
    c = fmt[i] & 0xff;
 677:	8b 85 44 ff ff ff    	mov    -0xbc(%rbp),%eax
 67d:	48 63 d0             	movslq %eax,%rdx
 680:	48 8b 85 10 ff ff ff 	mov    -0xf0(%rbp),%rax
 687:	48 01 d0             	add    %rdx,%rax
 68a:	0f b6 00             	movzbl (%rax),%eax
 68d:	0f be c0             	movsbl %al,%eax
 690:	25 ff 00 00 00       	and    $0xff,%eax
 695:	89 85 3c ff ff ff    	mov    %eax,-0xc4(%rbp)
    if(state == 0){
 69b:	83 bd 40 ff ff ff 00 	cmpl   $0x0,-0xc0(%rbp)
 6a2:	75 35                	jne    6d9 <printf+0x104>
      if(c == '%'){
 6a4:	83 bd 3c ff ff ff 25 	cmpl   $0x25,-0xc4(%rbp)
 6ab:	75 0f                	jne    6bc <printf+0xe7>
        state = '%';
 6ad:	c7 85 40 ff ff ff 25 	movl   $0x25,-0xc0(%rbp)
 6b4:	00 00 00 
 6b7:	e9 5c 02 00 00       	jmp    918 <printf+0x343>
      } else {
        putc(fd, c);
 6bc:	8b 85 3c ff ff ff    	mov    -0xc4(%rbp),%eax
 6c2:	0f be d0             	movsbl %al,%edx
 6c5:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
 6cb:	89 d6                	mov    %edx,%esi
 6cd:	89 c7                	mov    %eax,%edi
 6cf:	e8 0f fe ff ff       	call   4e3 <putc>
 6d4:	e9 3f 02 00 00       	jmp    918 <printf+0x343>
      }
    } else if(state == '%'){
 6d9:	83 bd 40 ff ff ff 25 	cmpl   $0x25,-0xc0(%rbp)
 6e0:	0f 85 32 02 00 00    	jne    918 <printf+0x343>
      if(c == 'd'){
 6e6:	83 bd 3c ff ff ff 64 	cmpl   $0x64,-0xc4(%rbp)
 6ed:	75 5e                	jne    74d <printf+0x178>
        printint(fd, va_arg(ap, int), 10, 1);
 6ef:	8b 85 20 ff ff ff    	mov    -0xe0(%rbp),%eax
 6f5:	83 f8 2f             	cmp    $0x2f,%eax
 6f8:	77 23                	ja     71d <printf+0x148>
 6fa:	48 8b 85 30 ff ff ff 	mov    -0xd0(%rbp),%rax
 701:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
 707:	89 d2                	mov    %edx,%edx
 709:	48 01 d0             	add    %rdx,%rax
 70c:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
 712:	83 c2 08             	add    $0x8,%edx
 715:	89 95 20 ff ff ff    	mov    %edx,-0xe0(%rbp)
 71b:	eb 12                	jmp    72f <printf+0x15a>
 71d:	48 8b 85 28 ff ff ff 	mov    -0xd8(%rbp),%rax
 724:	48 8d 50 08          	lea    0x8(%rax),%rdx
 728:	48 89 95 28 ff ff ff 	mov    %rdx,-0xd8(%rbp)
 72f:	8b 30                	mov    (%rax),%esi
 731:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
 737:	b9 01 00 00 00       	mov    $0x1,%ecx
 73c:	ba 0a 00 00 00       	mov    $0xa,%edx
 741:	89 c7                	mov    %eax,%edi
 743:	e8 c8 fd ff ff       	call   510 <printint>
 748:	e9 c1 01 00 00       	jmp    90e <printf+0x339>
      } else if(c == 'x' || c == 'p'){
 74d:	83 bd 3c ff ff ff 78 	cmpl   $0x78,-0xc4(%rbp)
 754:	74 09                	je     75f <printf+0x18a>
 756:	83 bd 3c ff ff ff 70 	cmpl   $0x70,-0xc4(%rbp)
 75d:	75 5e                	jne    7bd <printf+0x1e8>
        printint(fd, va_arg(ap, int), 16, 0);
 75f:	8b 85 20 ff ff ff    	mov    -0xe0(%rbp),%eax
 765:	83 f8 2f             	cmp    $0x2f,%eax
 768:	77 23                	ja     78d <printf+0x1b8>
 76a:	48 8b 85 30 ff ff ff 	mov    -0xd0(%rbp),%rax
 771:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
 777:	89 d2                	mov    %edx,%edx
 779:	48 01 d0             	add    %rdx,%rax
 77c:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
 782:	83 c2 08             	add    $0x8,%edx
 785:	89 95 20 ff ff ff    	mov    %edx,-0xe0(%rbp)
 78b:	eb 12                	jmp    79f <printf+0x1ca>
 78d:	48 8b 85 28 ff ff ff 	mov    -0xd8(%rbp),%rax
 794:	48 8d 50 08          	lea    0x8(%rax),%rdx
 798:	48 89 95 28 ff ff ff 	mov    %rdx,-0xd8(%rbp)
 79f:	8b 30                	mov    (%rax),%esi
 7a1:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
 7a7:	b9 00 00 00 00       	mov    $0x0,%ecx
 7ac:	ba 10 00 00 00       	mov    $0x10,%edx
 7b1:	89 c7                	mov    %eax,%edi
 7b3:	e8 58 fd ff ff       	call   510 <printint>
 7b8:	e9 51 01 00 00       	jmp    90e <printf+0x339>
      } else if(c == 's'){
 7bd:	83 bd 3c ff ff ff 73 	cmpl   $0x73,-0xc4(%rbp)
 7c4:	0f 85 98 00 00 00    	jne    862 <printf+0x28d>
        s = va_arg(ap, char*);
 7ca:	8b 85 20 ff ff ff    	mov    -0xe0(%rbp),%eax
 7d0:	83 f8 2f             	cmp    $0x2f,%eax
 7d3:	77 23                	ja     7f8 <printf+0x223>
 7d5:	48 8b 85 30 ff ff ff 	mov    -0xd0(%rbp),%rax
 7dc:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
 7e2:	89 d2                	mov    %edx,%edx
 7e4:	48 01 d0             	add    %rdx,%rax
 7e7:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
 7ed:	83 c2 08             	add    $0x8,%edx
 7f0:	89 95 20 ff ff ff    	mov    %edx,-0xe0(%rbp)
 7f6:	eb 12                	jmp    80a <printf+0x235>
 7f8:	48 8b 85 28 ff ff ff 	mov    -0xd8(%rbp),%rax
 7ff:	48 8d 50 08          	lea    0x8(%rax),%rdx
 803:	48 89 95 28 ff ff ff 	mov    %rdx,-0xd8(%rbp)
 80a:	48 8b 00             	mov    (%rax),%rax
 80d:	48 89 85 48 ff ff ff 	mov    %rax,-0xb8(%rbp)
        if(s == 0)
 814:	48 83 bd 48 ff ff ff 	cmpq   $0x0,-0xb8(%rbp)
 81b:	00 
 81c:	75 31                	jne    84f <printf+0x27a>
          s = "(null)";
 81e:	48 c7 85 48 ff ff ff 	movq   $0xc3a,-0xb8(%rbp)
 825:	3a 0c 00 00 
        while(*s != 0){
 829:	eb 24                	jmp    84f <printf+0x27a>
          putc(fd, *s);
 82b:	48 8b 85 48 ff ff ff 	mov    -0xb8(%rbp),%rax
 832:	0f b6 00             	movzbl (%rax),%eax
 835:	0f be d0             	movsbl %al,%edx
 838:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
 83e:	89 d6                	mov    %edx,%esi
 840:	89 c7                	mov    %eax,%edi
 842:	e8 9c fc ff ff       	call   4e3 <putc>
          s++;
 847:	48 83 85 48 ff ff ff 	addq   $0x1,-0xb8(%rbp)
 84e:	01 
        while(*s != 0){
 84f:	48 8b 85 48 ff ff ff 	mov    -0xb8(%rbp),%rax
 856:	0f b6 00             	movzbl (%rax),%eax
 859:	84 c0                	test   %al,%al
 85b:	75 ce                	jne    82b <printf+0x256>
 85d:	e9 ac 00 00 00       	jmp    90e <printf+0x339>
        }
      } else if(c == 'c'){
 862:	83 bd 3c ff ff ff 63 	cmpl   $0x63,-0xc4(%rbp)
 869:	75 56                	jne    8c1 <printf+0x2ec>
        putc(fd, va_arg(ap, uint));
 86b:	8b 85 20 ff ff ff    	mov    -0xe0(%rbp),%eax
 871:	83 f8 2f             	cmp    $0x2f,%eax
 874:	77 23                	ja     899 <printf+0x2c4>
 876:	48 8b 85 30 ff ff ff 	mov    -0xd0(%rbp),%rax
 87d:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
 883:	89 d2                	mov    %edx,%edx
 885:	48 01 d0             	add    %rdx,%rax
 888:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
 88e:	83 c2 08             	add    $0x8,%edx
 891:	89 95 20 ff ff ff    	mov    %edx,-0xe0(%rbp)
 897:	eb 12                	jmp    8ab <printf+0x2d6>
 899:	48 8b 85 28 ff ff ff 	mov    -0xd8(%rbp),%rax
 8a0:	48 8d 50 08          	lea    0x8(%rax),%rdx
 8a4:	48 89 95 28 ff ff ff 	mov    %rdx,-0xd8(%rbp)
 8ab:	8b 00                	mov    (%rax),%eax
 8ad:	0f be d0             	movsbl %al,%edx
 8b0:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
 8b6:	89 d6                	mov    %edx,%esi
 8b8:	89 c7                	mov    %eax,%edi
 8ba:	e8 24 fc ff ff       	call   4e3 <putc>
 8bf:	eb 4d                	jmp    90e <printf+0x339>
      } else if(c == '%'){
 8c1:	83 bd 3c ff ff ff 25 	cmpl   $0x25,-0xc4(%rbp)
 8c8:	75 1a                	jne    8e4 <printf+0x30f>
        putc(fd, c);
 8ca:	8b 85 3c ff ff ff    	mov    -0xc4(%rbp),%eax
 8d0:	0f be d0             	movsbl %al,%edx
 8d3:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
 8d9:	89 d6                	mov    %edx,%esi
 8db:	89 c7                	mov    %eax,%edi
 8dd:	e8 01 fc ff ff       	call   4e3 <putc>
 8e2:	eb 2a                	jmp    90e <printf+0x339>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 8e4:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
 8ea:	be 25 00 00 00       	mov    $0x25,%esi
 8ef:	89 c7                	mov    %eax,%edi
 8f1:	e8 ed fb ff ff       	call   4e3 <putc>
        putc(fd, c);
 8f6:	8b 85 3c ff ff ff    	mov    -0xc4(%rbp),%eax
 8fc:	0f be d0             	movsbl %al,%edx
 8ff:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
 905:	89 d6                	mov    %edx,%esi
 907:	89 c7                	mov    %eax,%edi
 909:	e8 d5 fb ff ff       	call   4e3 <putc>
      }
      state = 0;
 90e:	c7 85 40 ff ff ff 00 	movl   $0x0,-0xc0(%rbp)
 915:	00 00 00 
  for(i = 0; fmt[i]; i++){
 918:	83 85 44 ff ff ff 01 	addl   $0x1,-0xbc(%rbp)
 91f:	8b 85 44 ff ff ff    	mov    -0xbc(%rbp),%eax
 925:	48 63 d0             	movslq %eax,%rdx
 928:	48 8b 85 10 ff ff ff 	mov    -0xf0(%rbp),%rax
 92f:	48 01 d0             	add    %rdx,%rax
 932:	0f b6 00             	movzbl (%rax),%eax
 935:	84 c0                	test   %al,%al
 937:	0f 85 3a fd ff ff    	jne    677 <printf+0xa2>
    }
  }
}
 93d:	90                   	nop
...
free(void *ap)
{
 ...
 a46:	48 8b 10             	mov    (%rax),%rdx
 a49:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
 a4d:	48 89 10             	mov    %rdx,(%rax)
 a50:	eb 0b                	jmp    a5d <free+0x11c>
  } else
    p->s.ptr = bp;
 a52:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
 a56:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
 a5a:	48 89 10             	mov    %rdx,(%rax)
  freep = p;
 a5d:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
 a61:	48 89 05 58 04 00 00 	mov    %rax,0x458(%rip)        # ec0 <freep>
}
 a68:	90                   	nop
 a69:	c9                   	leave
 a6a:	c3                   	ret

0000000000000a6b <morecore>:
...
morecore(uint nu)
{
 ...
 a73:	48 83 ec 20          	sub    $0x20,%rsp
 a77:	89 7d ec             	mov    %edi,-0x14(%rbp)
  char *p;
  Header *hp;

  if(nu < 4096)
 a7a:	81 7d ec ff 0f 00 00 	cmpl   $0xfff,-0x14(%rbp)
 a81:	77 07                	ja     a8a <morecore+0x1f>
    nu = 4096;
 a83:	c7 45 ec 00 10 00 00 	movl   $0x1000,-0x14(%rbp)
  p = sbrk(nu * sizeof(Header));
 a8a:	8b 45 ec             	mov    -0x14(%rbp),%eax
 a8d:	c1 e0 04             	shl    $0x4,%eax
 a90:	89 c7                	mov    %eax,%edi
 a92:	e8 0c fa ff ff       	call   4a3 <sbrk>
 a97:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
  if(p == (char*)-1)
 a9b:	48 83 7d f8 ff       	cmpq   $0xffffffffffffffff,-0x8(%rbp)
 aa0:	75 07                	jne    aa9 <morecore+0x3e>
    return 0;
 aa2:	b8 00 00 00 00       	mov    $0x0,%eax
 aa7:	eb 29                	jmp    ad2 <morecore+0x67>
  hp = (Header*)p;
 aa9:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
 aad:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
  hp->s.size = nu;
 ab1:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
 ab5:	8b 55 ec             	mov    -0x14(%rbp),%edx
 ab8:	89 50 08             	mov    %edx,0x8(%rax)
  free((void*)(hp + 1));
 abb:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
 abf:	48 83 c0 10          	add    $0x10,%rax
 ac3:	48 89 c7             	mov    %rax,%rdi
 ac6:	e8 76 fe ff ff       	call   941 <free>
  return freep;
 acb:	48 8b 05 ee 03 00 00 	mov    0x3ee(%rip),%rax        # ec0 <freep>
}
 ad2:	c9                   	leave
 ad3:	c3                   	ret
...
malloc(uint nbytes)
{
 ad4:	f3 0f 1e fa          	endbr64
 ad8:	55                   	push   %rbp
 ad9:	48 89 e5             	mov    %rsp,%rbp
 adc:	48 83 ec 30          	sub    $0x30,%rsp
 ae0:	89 7d dc             	mov    %edi,-0x24(%rbp)
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ae3:	8b 45 dc             	mov    -0x24(%rbp),%eax
 ae6:	48 83 c0 0f          	add    $0xf,%rax
 aea:	48 c1 e8 04          	shr    $0x4,%rax
 aee:	83 c0 01             	add    $0x1,%eax
 af1:	89 45 ec             	mov    %eax,-0x14(%rbp)
  if((prevp = freep) == 0){
 af4:	48 8b 05 c5 03 00 00 	mov    0x3c5(%rip),%rax        # ec0 <freep>
 afb:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
 aff:	48 83 7d f0 00       	cmpq   $0x0,-0x10(%rbp)
 b04:	75 2b                	jne    b31 <malloc+0x5d>
    base.s.ptr = freep = prevp = &base;
 b06:	48 c7 45 f0 b0 0e 00 	movq   $0xeb0,-0x10(%rbp)
 b0d:	00 
 b0e:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
 b12:	48 89 05 a7 03 00 00 	mov    %rax,0x3a7(%rip)        # ec0 <freep>
 b19:	48 8b 05 a0 03 00 00 	mov    0x3a0(%rip),%rax        # ec0 <freep>
 b20:	48 89 05 89 03 00 00 	mov    %rax,0x389(%rip)        # eb0 <base>
    base.s.size = 0;
 b27:	c7 05 87 03 00 00 00 	movl   $0x0,0x387(%rip)        # eb8 <base+0x8>
 b2e:	00 00 00 
  }
 ...
 b43:	3b 45 ec             	cmp    -0x14(%rbp),%eax
 b46:	72 5f                	jb     ba7 <malloc+0xd3>
      if(p->s.size == nunits)
 b48:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
 b4c:	8b 40 08             	mov    0x8(%rax),%eax
 b4f:	39 45 ec             	cmp    %eax,-0x14(%rbp)
 b52:	75 10                	jne    b64 <malloc+0x90>
        prevp->s.ptr = p->s.ptr;
 b54:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
 b58:	48 8b 10             	mov    (%rax),%rdx
 b5b:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
 b5f:	48 89 10             	mov    %rdx,(%rax)
 b62:	eb 2e                	jmp    b92 <malloc+0xbe>
      else {
        p->s.size -= nunits;
 b64:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
 b68:	8b 40 08             	mov    0x8(%rax),%eax
 b6b:	2b 45 ec             	sub    -0x14(%rbp),%eax
 b6e:	89 c2                	mov    %eax,%edx
 b70:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
 b74:	89 50 08             	mov    %edx,0x8(%rax)
        p += p->s.size;
 b77:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
 b7b:	8b 40 08             	mov    0x8(%rax),%eax
 b7e:	89 c0                	mov    %eax,%eax
 b80:	48 c1 e0 04          	shl    $0x4,%rax
 b84:	48 01 45 f8          	add    %rax,-0x8(%rbp)
        p->s.size = nunits;
 b88:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
 b8c:	8b 55 ec             	mov    -0x14(%rbp),%edx
 b8f:	89 50 08             	mov    %edx,0x8(%rax)
      }
      freep = prevp;
 b92:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
 b96:	48 89 05 23 03 00 00 	mov    %rax,0x323(%rip)        # ec0 <freep>
      return (void*)(p + 1);
 b9d:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
 ba1:	48 83 c0 10          	add    $0x10,%rax
 ba5:	eb 41                	jmp    be8 <malloc+0x114>
    }
    if(p == freep)
 ba7:	48 8b 05 12 03 00 00 	mov    0x312(%rip),%rax        # ec0 <freep>
 bae:	48 39 45 f8          	cmp    %rax,-0x8(%rbp)
 bb2:	75 1c                	jne    bd0 <malloc+0xfc>
      if((p = morecore(nunits)) == 0)
 bb4:	8b 45 ec             	mov    -0x14(%rbp),%eax
 bb7:	89 c7                	mov    %eax,%edi
 bb9:	e8 ad fe ff ff       	call   a6b <morecore>
 bbe:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
 bc2:	48 83 7d f8 00       	cmpq   $0x0,-0x8(%rbp)
 bc7:	75 07                	jne    bd0 <malloc+0xfc>
        return 0;
 bc9:	b8 00 00 00 00       	mov    $0x0,%eax
 bce:	eb 18                	jmp    be8 <malloc+0x114>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 bd0:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
 bd4:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
 bd8:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
 bdc:	48 8b 00             	mov    (%rax),%rax
 bdf:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    if(p->s.size >= nunits){
 be3:	e9 54 ff ff ff       	jmp    b3c <malloc+0x68>
  }
}
 be8:	c9                   	leave
 be9:	c3                   	ret
